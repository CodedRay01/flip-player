!function() {
    "use strict";
    var e, t = {}, i = 0, n = !1, a = null, s = null, r = function() {
        return window.location.href.split("#")
    };
    window.Hash = (e = {
        pushState: function(e) {
            return window.history && window.history.pushState && (n = e),
            this
        },
        fragment: function() {
            var e = r();
        ...
        get: function(e, t) {
            var i, a = [];
            for (i in t)
                Object.prototype.hasOwnProperty(i) && a.push(encodeURIComponent(i) + "=" + encodeURIComponent(t[i]));
            return a.length > 0 && (a = "?" + a.join("&")),
            n ? e + a : r()[0] + "#" + e + a
        },
        go: function(e, t) {
            if (this.fragment() != e) {
        ...
        on: function(e, n, r) {
            ...
            a || (a = setInterval((function() {
                i > 0 && s != window.location.href && (s = window.location.href,
                window.Hash.check())
            }
            ), 100)),
            this
        ...
        check: function() {
            var e, i, n, a = this.fragment();
            for (i in t)
                if (Object.prototype.hasOwnProperty.call(t, i))
                    if (t[i].regexp = t[i].regexp || new RegExp(i),
                    n = t[i].regexp.exec(a))
                        for (t[i].title && (document.title = t[i].title),
                        e = 0; e < t[i].listeners.length; e++)
                            t[i].listeners[e].yep && t[i].listeners[e].yep(a, n);
                    else
                        for (e = 0; e < t[i].listeners.length; e++)
                            t[i].listeners[e].nop && t[i].listeners[e].nop(a);
            return this
        }
    },
    ...
    var t, i = {
        ...
        init: function(a) {
            var r = this
              , o = this.data()
              , c = e.extend({}, i, a);
            if (!c.flipbook || !c.flipbook.turn("is"))
                throw s("options.flipbook is required");
            if (t = "WebKitCSSMatrix"in window || "MozPerspective"in document.body.style,
            "function" != typeof c.max) {
                var p = c.max;
                c.max = function() {
                    return p
                }
            ...
            for (var u in o.zoom = {
                ...
                flipbookEvents: {
                    zooming: d(n._eZoom, r),
                    pressed: d(n._ePressed, r),
                    released: d(n._eReleased, r),
                    start: d(n._eStart, r),
                    turning: d(n._eTurning, r),
                    turned: d(n._eTurned, r),
                    destroying: d(n._eDestroying, r)
                }
            },
            c.when)
                Object.prototype.hasOwnProperty.call(c.when, u) && this.bind("zoom." + u, c.when[u]);
            for (u in o.zoom.flipbookEvents)
                Object.prototype.hasOwnProperty.call(o.zoom.flipbookEvents, u) && c.flipbook.bind(u, o.zoom.flipbookEvents[u]);
            this.css({
                position: "relative",
                overflow: "hidden"
            }),
            e.isTouch ? (c.flipbook.bind("touchstart", o.zoom.eventTouchStart).bind("touchmove", o.zoom.eventTouchMove).bind("touchend", o.zoom.eventTouchEnd),
            this.bind("touchstart", n._tap)) : this.mousedown(n._mousedown).click(n._tap)
        },
        _tap: function(t) {
            var i = e(this)
              , s = i.data().zoom;
        ...
        _addEvent: function(e, t) {
            ...
            i.eventQueue.push(n),
            i.eventQueue.length > 10 && i.eventQueue.splice(0, 1)
        },
        _eventSeq: function() {
            var t = this.data().zoom.eventQueue
              , i = t.length - 1;
            return i > 0 && "tap" == t[i].name && "tap" == t[i - 1].name && t[i].event.pageX == t[i - 1].event.pageX && t[i].event.pageY == t[i - 1].event.pageY && t[i].timestamp - t[i - 1].timestamp < 200 && t[i].timestamp - t[i - 1].timestamp > 50 ? e.extend(t[i].event, {
                type: "zoom.doubleTap"
            }) : "tap" == t[i].name ? e.extend(t[i].event, {
                type: "zoom.tap"
            }) : void 0
        },
        _prepareZoom: function() {
            var t, i = 0, n = this.data().zoom, a = 1 / this.zoom("value"), s = n.opts.flipbook, r = s.turn("direction"), o = s.data(), d = s.offset(), c = this.offset(), p = {
                height: s.height()
            }, u = s.turn("view");
            "double" == s.turn("display") && s.data().opts.autoCenter ? u[0] ? u[1] ? (p.width = s.width(),
            t = l(d.left - c.left, d.top - c.top)) : (p.width = s.width() / 2,
            i = "ltr" == r ? 0 : p.width,
            t = l("ltr" == r ? d.left - c.left : d.left - c.left + p.width, d.top - c.top)) : (p.width = s.width() / 2,
            i = "ltr" == r ? p.width : 0,
            t = l("ltr" == r ? d.left - c.left + p.width : d.left - c.left, d.top - c.top)) : (p.width = s.width(),
            t = l(d.left - c.left, d.top - c.top)),
            n.zoomer || (n.zoomer = e("<div />", {
                class: "zoomer",
                css: {
                    overflow: "hidden",
                    position: "absolute",
            ...
            if (h != n.zoomerView) {
                n.zoomerView = h,
                n.zoomer.find("*").remove();
                for (var f = 0; f < u.length; f++)
                    if (u[f]) {
                        var m = o.pageObjs[u[f]].offset()
                          , g = e(o.pageObjs[u[f]]);
                        g.clone().transform("").css({
                            width: g.width() * a,
                            height: g.height() * a,
                            position: "absolute",
                            display: "",
                            top: (m.top - d.top) * a,
                            left: (m.left - d.left - i) * a
                        }).appendTo(n.zoomer)
                    }
            }
            return {
        ...
        zoomIn: function(t) {
            var i, a = this, s = this.data().zoom, d = s.opts.flipbook, c = s.opts.max(), p = (d.offset(),
            this.offset());
            if (s.zoomIn)
                return this;
            d.turn("stop");
            ...
            s.scale = c,
            d.data().noCenter = !0,
            ((i = void 0 !== t ? "x"in t && "y"in t ? l(t.x - f.x, t.y - f.y) : e.isTouch ? l(t.originalEvent.touches[0].pageX - f.x - p.left, t.originalEvent.touches[0].pageY - f.y - p.top) : l(t.pageX - f.x - p.left, t.pageY - f.y - p.top) : l(m.x, m.y)).x < 0 || i.y < 0 || i.x > h.width || i.y > h.height) && (i.x = m.x,
            i.y = m.y);
            ...
            T.y > _.y ? b.y = T.y - _.y + b.y : T.y < x.y && (b.y = T.y - x.y + b.y),
            T.x > _.x ? b.x = T.x - _.x + b.x : T.x < x.x && (b.x = T.x - x.x + b.x),
            T = l(m.x * c - m.x - f.x - b.x, m.y * c - m.y - f.y - b.y);
            var E = {};
            E[g + "transition"] = g + "transform " + s.opts.easeFunction + " " + s.opts.duration + "ms";
            var S = function() {
                a.trigger("zoom.zoomIn"),
                s.zoomIn = !0,
                s.flipPosition = l(d.css("left"), d.css("top")),
                d.turn("zoom", c).css({
                    position: "absolute",
                    margin: "",
                    top: 0,
            ...
            return s.zoomer.css(E).show(),
            v ? s.zoomer.bind(v, (function() {
                e(this).unbind(v),
                S()
            }
        ...
        zoomOut: function(t) {
            var i, a = this, s = this.data().zoom, d = s.opts.flipbook, c = 1 / s.scale, p = e.cssPrefix(), u = e.cssTransitionEnd(), h = this.offset();
            if (t = void 0 !== t ? t : s.opts.duration,
            s.zoomIn) {
                ...
                var m = {};
                m[p + "transition"] = p + "transform " + s.opts.easeFunction + " " + t + "ms",
                d.css(m);
                var g, v = e("<div />", {
                    css: {
                        position: "relative",
                ...
                g = l(v.offset().left - h.left, v.offset().top - h.top),
                v.remove();
                var w = d.data().opts.autoCenter;
                w && "double" == d.turn("display") && (d.turn("view")[0] ? d.turn("view")[1] || (g.x = "ltr" == d.turn("direction") ? g.x + v.width() / 4 : g.x - v.width() / 4) : g.x = "ltr" == d.turn("direction") ? g.x - v.width() / 4 : g.x + v.width() / 4);
                var y = e.findPos(d[0]);
                i = l(-d.width() / 2 - y.left + v.width() / 2 + g.x + h.left, -d.height() / 2 - y.top + v.height() / 2 + g.y + h.top);
                var b = function() {
                    d[0].style.removeProperty ? (d[0].style.removeProperty(p + "transition"),
                    ...
                    d.css({
                        ...
                        top: s.flipPosition.y,
                        left: s.flipPosition.x
                    })) : d.transform("none").turn("zoom", 1).css({
                        margin: "",
                        top: s.flipPosition.y,
                        left: s.flipPosition.x,
                        position: "relative"
                ...
                return 0 === t ? b() : u ? (d.bind(u, (function() {
                    e(this).unbind(u),
                    b()
                }
                )),
                d.transform(r(i.x, i.y, !0) + o(c, !0))) : (setTimeout(b, t),
        ...
        scroll: function(i, n, a) {
            var s = this.data().zoom
              , o = s.opts.flipbook
              , d = (this.zoom("flipbookWidth"),
            e.cssPrefix());
            if (t) {
                var c = {};
                c[d + "transition"] = a ? d + "transform 200ms" : "none",
                o.css(c),
                o.transform(r(-s.axis.x - i.x, -s.axis.y - i.y, !0))
            } else
                o.css({
                    top: -s.axis.y - i.y,
                    left: -s.axis.x - i.x
        ...
        _eZoom: function() {
            for (var e = this.data().zoom, t = e.opts.flipbook, i = t.turn("view"), n = 0; n < i.length; n++)
                i[n] && this.trigger("zoom.resize", [e.scale, i[n], t.data().pageObjs[i[n]]])
        },
        ...
        _eTurning: function(e, t, i) {
            var n = this
              ...
              , s = this.data().zoom
              , r = s.opts.flipbook;
            if (s.page = r.turn("page"),
            1 != a) {
                for (var o = 0; o < i.length; o++)
                    i[o] && this.trigger("zoom.resize", [a, i[o], r.data().pageObjs[i[o]]]);
                setTimeout((function() {
                    n.zoom("resize")
                }
                ), 0)
        ...
        _eMouseDown: function(t) {
            return e(this).data().zoom.draggingCur = e.isTouch ? l(t.originalEvent.touches[0].pageX, t.originalEvent.touches[0].pageY) : l(t.pageX, t.pageY),
            !1
        },
        _eMouseMove: function(t) {
            ...
            if (i.draggingCur) {
                ...
                return e(this).zoom("scroll", l(i.scrollPos.x - a.x, i.scrollPos.y - a.y), !0),
                i.draggingCur = n,
                !1
            }
        },
        ...
        _eTouchStart: function(t, i) {
            var n = e(this).data().zoom
              , a = (n.opts.flipbook,
            l(t.originalEvent.touches[0].pageX, t.originalEvent.touches[0].pageY));
            n.touch = {},
            n.touch.initial = a,
            n.touch.last = a,
            n.touch.timestamp = (new Date).getTime(),
            n.touch.speed = l(0, 0)
        },
        _eTouchMove: function(t) {
            ...
            i.touch && 1 == n && !a.data().mouseAction && (i.touch.motion = l(r.x - i.touch.last.x, r.y - i.touch.last.y),
        ...
        _eTouchEnd: function(t) {
            ...
            if (i.touch && 1 == e(this).zoom("value")) {
                ...
                n < 50 && (i.touch.speed.x < -1 || i.touch.last.x - i.touch.initial.x < -100) ? this.trigger("zoom.swipeLeft") : n < 50 && (i.touch.speed.x > 1 || i.touch.last.x - i.touch.initial.x > 100) && this.trigger("zoom.swipeRight")
            }
        },
        _eDestroying: function() {
            ...
            a.unbind("touchstart", i.eventTouchStart).unbind("touchmove", i.eventTouchMove).unbind("touchend", i.eventTouchEnd),
            this.unbind("touchstart", n._tap).unbind("click", n._tap),
            i = null,
            this.data().zoom = null
        }
    };
    ...
    e.extend(e.fn, {
        zoom: function() {
            ...
            if (t[0] && "object" != typeof t[0]) {
                if (n[t[0]])
                    return n[t[0]].apply(e(this[0]), Array.prototype.slice.call(t, 1));
...
function(e) {
    "use strict";
    var t, i, n = "", a = Math.PI, s = a / 2, r = "ontouchstart"in window, o = r ? {
        down: "touchstart",
        move: "touchmove",
        up: "touchend",
        over: "touchstart",
        ...
        init: function(a) {
            var s;
            t = "WebKitCSSMatrix"in window || "MozPerspective"in document.body.style,
            i = !(s = /AppleWebkit\/([0-9\.]+)/i.exec(navigator.userAgent)) || parseFloat(s[1]) > 534.3,
            n = x();
            var l, d = 0, c = this.data(), u = this.children();
            if (a = e.extend({
                width: this.width(),
                height: this.height(),
            ...
            c.eventHandlers = {
                touchStart: e.proxy(h._touchStart, this),
                touchMove: e.proxy(h._touchMove, this),
                touchEnd: e.proxy(h._touchEnd, this),
                start: e.proxy(h._eventStart, this)
            },
            a.when)
                for (l in a.when)
                    _(l, a.when) && this.bind(l, a.when[l]);
            for (this.css({
                position: "relative",
                width: a.width,
                height: a.height
            ...
            return e(this).bind(o.down, c.eventHandlers.touchStart).bind("end", h._eventEnd).bind("pressed", h._eventPressed).bind("released", h._eventReleased).bind("flip", h._flip),
        ...
        addPage: function(t, i) {
            var n, a, s = !1, r = this.data(), o = r.totalPages + 1;
            if (r.destroying)
                return !1;
            if ((n = /\bp([0-9]+)\b/.exec(e(t).attr("class"))) && (i = parseInt(n[1], 10)),
            i) {
                if (i == o)
                    s = !0;
                else if (i > o)
                    throw S('Page "' + i + '" cannot be inserted')
            } else
                i = o,
                s = !0;
            return i >= 1 && i <= o && (a = "double" == r.display ? i % 2 ? " odd" : " even" : "",
            r.done && this.turn("stop"),
            i in r.pageObjs && h._movePages.call(this, i, 1),
            s && (r.totalPages = o),
            r.pageObjs[i] = e(t).css({
                float: "left"
            }).addClass("page p" + i + a),
            ...
            if (n)
                if (h._necessPage.call(this, t)) {
                    if (!i.pageWrap[t]) {
                        ...
                        i.pagePlace[t] || (i.pagePlace[t] = t,
                        i.pageObjs[t].appendTo(i.pageWrap[t]));
                    ...
                    i.pagePlace[t] = 0,
                    i.pageObjs[t] && i.pageObjs[t].remove()
        },
        hasPage: function(e) {
        ...
        destroy: function() {
            ...
            if ("prevented" != E("destroying", this)) {
                ...
                e(document).unbind(o.move, i.eventHandlers.touchMove).unbind(o.up, i.eventHandlers.touchEnd); 0 !== i.totalPages; )
                    this.turn("removePage", i.totalPages);
                return i.fparent && i.fparent.remove(),
                i.shadow && i.shadow.remove(),
                this.removeData(),
                i = null,
                this
            }
        ...
        zoom: function(t) {
            ...
            if ("number" == typeof t) {
                if (t < .001 || t > 100)
                    throw S(t + " is not a value for zoom");
                if ("prevented" == E("zooming", this, [t, i.zoom]))
                    return this;
                ...
                i.zoom = t,
                e(this).turn("stop").turn("size", r, o),
                i.opts.autoCenter && this.turn("center"),
                h._updateShadow.call(this);
                for (var l = 0; l < a.length; l++)
                    a[l] && i.pageZoom[a[l]] != i.zoom && (this.trigger("zoomed", [a[l], a, i.pageZoom[a[l]], i.zoom]),
                    i.pageZoom[a[l]] = i.zoom);
                return this
            }
            return i.zoom
        },
        _pageSize: function(e, t) {
            ...
            if ("single" == i.display)
                ...
                var a = this.width() / 2
                  , s = this.height();
                if (i.pageObjs[e].hasClass("own-size") ? (n.width = i.pageObjs[e].width(),
                n.height = i.pageObjs[e].height()) : (n.width = a,
                n.height = s),
                t) {
                    var r = e % 2;
                    n.top = (s - n.height) / 2,
                    "ltr" == i.direction ? (n[r ? "right" : "left"] = a - n.width,
                    n[r ? "left" : "right"] = "auto") : (n[r ? "left" : "right"] = a - n.width,
                    n[r ? "right" : "left"] = "auto")
                }
            }
            return n
        ...
        _makeFlip: function(e) {
            ...
            if (!t.pages[e] && t.pagePlace[e] == e) {
                var i = "single" == t.display
                  , n = e % 2;
                t.pages[e] = t.pageObjs[e].css(h._pageSize.call(this, e)).flip({
                    page: e,
                    next: n || i ? e + 1 : e - 1,
                    turn: this
        ...
        _makeRange: function() {
            ...
            if (!(this.data().totalPages < 1))
                for (e = (t = this.turn("range"))[0]; e <= t[1]; e++)
                    h._addPage.call(this, e)
        },
        range: function(e) {
            var t, i, n, a, s = this.data();
            if (e = e || s.tpage || s.page || 1,
            a = h._view.call(this, e),
            e < 1 || e > s.totalPages)
                throw S('"' + e + '" is not a valid page');
            return a[1] = a[1] || a[0],
            a[0] >= 1 && a[1] <= s.totalPages ? (t = Math.floor(2),
            s.totalPages - a[1] > a[0] ? n = 2 * t - (i = Math.min(a[0] - 1, t)) : i = 2 * t - (n = Math.min(s.totalPages - a[1], t))) : (i = 5,
            n = 5),
        ...
        _removeFromDOM: function() {
            var e, t = this.data();
            for (e in t.pageWrap)
                _(e, t.pageWrap) && !h._necessPage.call(this, e) && h._removePageFromDOM.call(this, e)
        },
        _removePageFromDOM: function(e) {
            var t = this.data();
            if (t.pages[e]) {
                var i = t.pages[e].data();
                f._moveFoldingPage.call(t.pages[e], !1),
                i.f && i.f.fwrapper && i.f.fwrapper.remove(),
        ...
        removePage: function(e) {
            ...
            if ("*" == e)
                ...
                if (e < 1 || e > t.totalPages)
                    throw S("The page " + e + " doesn't exist");
                t.pageObjs[e] && (this.turn("stop"),
                h._removePageFromDOM.call(this, e),
                delete t.pageObjs[e]),
                h._movePages.call(this, e, -1),
                t.totalPages = t.totalPages - 1,
                t.page > t.totalPages ? (t.page = null,
                h._fitPage.call(this, t.totalPages)) : (h._makeRange.call(this),
                this.turn("update"))
            }
            return this
        },
        _movePages: function(e, t) {
            var i, n = this, a = this.data(), s = "single" == a.display, r = function(e) {
                var i = e + t
                  , r = i % 2
                  , o = r ? " odd " : " even ";
                a.pageObjs[e] && (a.pageObjs[i] = a.pageObjs[e].removeClass("p" + e + " odd even").addClass("p" + i + o)),
                a.pagePlace[e] && a.pageWrap[e] && (a.pagePlace[i] = i,
                ...
                a.pages[e] && (a.pages[i] = a.pages[e].flip("options", {
                    page: i,
                    next: s || r ? i + 1 : i - 1
                })),
                t && (delete a.pages[e],
                delete a.pagePlace[e],
                delete a.pageZoom[e],
                delete a.pageObjs[e],
                delete a.pageWrap[e]))
            };
            if (t > 0)
                for (i = a.totalPages; i >= e; i--)
                    r(i);
            else
                for (i = e; i <= a.totalPages; i++)
                    r(i)
        },
        display: function(t) {
            var i = this.data()
            ...
            if (void 0 === t)
                return n;
            if (-1 == e.inArray(t, d))
                throw S('"' + t + '" is not a value for display');
            switch (t) {
            case "single":
        ...
        direction: function(t) {
            ...
            if (t = t.toLowerCase(),
            -1 == e.inArray(t, c))
                throw S('"' + t + '" is not a value for direction');
            return "rtl" == t && e(this).attr("dir", "ltr").css({
                direction: "ltr"
            }),
            i.direction = t,
            i.done && this.turn("size", e(this).width(), e(this).height()),
            this
        },
        animating: function() {
        ...
        corner: function() {
            var e, t, i = this.data();
            for (t in i.pages)
                if (_(t, i.pages) && (e = i.pages[t].flip("corner")))
                    return e;
            return !1
        },
        data: function() {
        ...
        disable: function(t) {
            var i, n = this.data(), a = this.turn("view");
            for (i in n.disabled = void 0 === t || !0 === t,
            n.pages)
                _(i, n.pages) && n.pages[i].flip("disable", !!n.disabled || -1 == e.inArray(parseInt(i, 10), a));
            return this
        },
        disabled: function(e) {
        ...
        size: function(e, t) {
            ...
            this.turn("stop");
            var i, n, a = this.data(), s = "double" == a.display ? e / 2 : e;
            for (i in this.css({
                width: e,
                height: t
            }),
            a.pageObjs[0] && a.pageObjs[0].css({
                width: s,
                height: t
            }),
            a.pageWrap)
                _(i, a.pageWrap) && (n = h._pageSize.call(this, i, !0),
                a.pageObjs[i].css({
                    width: n.width,
                    height: n.height
                }),
                a.pageWrap[i].css(n),
                a.pages[i] && a.pages[i].css({
                    width: n.width,
                    height: n.height
                }));
        ...
        _removeMv: function(e) {
            var t, i = this.data();
            for (t = 0; t < i.pageMv.length; t++)
                if (i.pageMv[t] == e)
                    return i.pageMv.splice(t, 1),
                    !0;
            return !1
        },
        _addMv: function(e) {
        ...
        _view: function(e) {
            var t = this.data();
            return e = e || t.page,
            "double" == t.display ? e % 2 ? [e - 1, e] : [e, e + 1] : [e]
        },
        view: function(e) {
            var t = this.data()
        ...
        stop: function(e, t) {
            if (this.turn("animating")) {
                var i, n, a, s = this.data();
                for (s.tpage && (s.page = s.tpage,
                delete s.tpage),
                i = 0; i < s.pageMv.length; i++)
                    s.pageMv[i] && s.pageMv[i] !== e && (n = (a = s.pages[s.pageMv[i]]).data().f.opts,
                    a.flip("hideFoldedPage", t),
                    t || f._moveFoldingPage.call(a, !1),
                    n.force && (n.next = n.page % 2 == 0 ? n.page - 1 : n.page + 1,
                    delete n.force))
            }
        ...
        pages: function(e) {
            ...
            if (e) {
                if (e < t.totalPages)
                    for (var i = t.totalPages; i > e; i--)
                        this.turn("removePage", i);
                return t.totalPages = e,
                h._fitPage.call(this, t.page),
                this
            }
            return t.totalPages
        },
        _missing: function(e) {
            var t = this.data();
            if (!(t.totalPages < 1)) {
                var i, n = this.turn("range", e), a = [];
                for (i = n[0]; i <= n[1]; i++)
                    t.pageObjs[i] || a.push(i);
        ...
        _fitPage: function(e) {
            var t = this.data()
              , i = this.turn("view", e);
            if (h._missing.call(this, e),
            t.pageObjs[e]) {
                t.page = e,
                this.turn("stop");
                for (var n = 0; n < i.length; n++)
                    i[n] && t.pageZoom[i[n]] != t.zoom && (this.trigger("zoomed", [i[n], i, t.pageZoom[i[n]], t.zoom]),
                    t.pageZoom[i[n]] = t.zoom);
                h._removeFromDOM.call(this),
                h._makeRange.call(this),
                h._updateShadow.call(this),
                this.trigger("turned", [e, i]),
                this.turn("update"),
                t.opts.autoCenter && this.turn("center")
            }
        },
        _turnPage: function(t) {
            var i, n, a = this.data(), s = a.pagePlace[t], r = this.turn("view"), o = this.turn("view", t);
            if (a.page != t) {
                var l = a.page;
                if ("prevented" == E("turning", this, [t, o]))
                    return void (l == a.page && -1 != e.inArray(s, a.pageMv) && a.pages[s].flip("hideFoldedPage", !0));
                -1 != e.inArray(1, o) && this.trigger("first"),
                -1 != e.inArray(a.totalPages, o) && this.trigger("last")
            }
            "single" == a.display ? (i = r[0],
            n = o[0]) : r[1] && t > r[1] ? (i = r[1],
            n = o[0]) : r[0] && t < r[0] && (i = r[0],
            n = o[1]);
            ...
            this.turn("update"),
            c.point = u,
            "hard" == c.effect ? "ltr" == a.direction ? a.pages[i].flip("turnPage", t > i ? "r" : "l") : a.pages[i].flip("turnPage", t > i ? "l" : "r") : "ltr" == a.direction ? a.pages[i].flip("turnPage", d[t > i ? 1 : 0]) : a.pages[i].flip("turnPage", d[t > i ? 0 : 1]))
        },
        page: function(t) {
            var i = this.data();
            if (void 0 === t)
            ...
            if (!i.disabled && !i.destroying) {
                if ((t = parseInt(t, 10)) > 0 && t <= i.totalPages)
                    return t != i.page && (i.done && -1 == e.inArray(t, this.turn("view")) ? h._turnPage.call(this, t) : h._fitPage.call(this, t)),
                    this;
        ...
        peel: function(e, t) {
            var i, n = this.data(), a = this.turn("view");
            (t = void 0 === t || !0 === t,
            !1 === e) ? this.turn("stop", null, t) : "single" == n.display ? n.pages[n.page].flip("peel", e, t) : (i = "ltr" == n.direction ? -1 != e.indexOf("l") ? a[0] : a[1] : -1 != e.indexOf("l") ? a[1] : a[0],
            n.pages[i] && n.pages[i].flip("peel", e, t));
            return this
        },
        ...
        _eventStart: function(e, t, i) {
            ...
            var n = t.turn.data()
              , a = n.pageZoom[t.page];
            e.isDefaultPrevented() || (a && a != n.zoom && (t.turn.trigger("zoomed", [t.page, t.turn.turn("view", t.page), a, n.zoom]),
            n.pageZoom[t.page] = n.zoom),
            "single" == n.display && i && (("l" == i.charAt(1) || "l" == i.charAt(0)) && "ltr" == n.direction || ("r" == i.charAt(1) || "r" == i.charAt(0)) && "rtl" == n.direction ? (t.next = t.next < t.page ? t.next : t.page - 1,
            t.force = !0) : t.next = t.next > t.page ? t.next : t.page + 1),
        ...
        _eventEnd: function(t, i, n) {
            ...
            var a = i.turn
              , s = a.data();
            if (null != i && null != i.turn && null != i.turn.trigger && i.turn.trigger("peelEnd", [i, n]),
            n) {
                var r = s.tpage || s.page;
                r != i.next && r != i.page || (delete s.tpage,
                h._fitPage.call(a, r || i.next, !0))
            } else
                h._removeMv.call(a, i.page),
                h._updateShadow.call(a),
                a.turn("update")
        },
        _eventPressed: function(t) {
            var i = e(t.target).data().f
              ...
              , a = n.data();
            a.pages;
            return a.mouseAction = !0,
            n.turn("update"),
            i.time = (new Date).getTime()
        },
        _eventReleased: function(t, i) {
            var n, a = e(t.target), s = a.data().f, r = s.opts.turn, o = r.data();
            n = "single" == o.display ? "br" == i.corner || "tr" == i.corner || "r" == i.corner ? i.x < a.width() / 2 : i.x > a.width() / 2 : i.x < 0 || i.x > a.width(),
            ((new Date).getTime() - s.time < 200 || n) && (t.preventDefault(),
            i && !0 === i.fit ? h._fitPage.call(r, s.opts.next) : h._turnPage.call(r, s.opts.next)),
            o.mouseAction = !1
        },
        _flip: function(t) {
            t.stopPropagation();
            var i = e(t.target).data().f.opts;
            i.turn.trigger("turn", [i.next]),
            i.turn.data().opts.autoCenter && i.turn.turn("center", i.next)
        },
        _touchStart: function(t) {
            if (null == t || null == t.target || "true" != e(t.target).attr("data-disable-events") && "start" != e(t.target).attr("data-disable-events") && "true" != e(t.target).closest(".layer-action-render").attr("data-disable-events") && "start" != e(t.target).closest(".layer-action-render").attr("data-disable-events"))
                if (null == window.disableTurnEvents || 1 != window.disableTurnEvents) {
                    var i = this.data();
                    for (var n in i.pages)
                        if (_(n, i.pages) && !1 === f._eventStart.apply(i.pages[n], arguments))
                            return !1
                } else
                    window.disableFirstMove = !0
        },
        _touchMove: function(t) {
            if ((null == t || null == t.target || "true" != e(t.target).attr("data-disable-events") && "true" != e(t.target).closest(".layer-action-render").attr("data-disable-events")) && (null == t || null == t.target || "start" != e(t.target).attr("data-disable-events") && "start" != e(t.target).closest(".layer-action-render").attr("data-disable-events") || null == t.originalEvent || null == t.originalEvent.buttons || 0 != t.originalEvent.buttons))
                if (null == window.disableTurnEvents || 1 != window.disableTurnEvents) {
                    n = this.data();
                    for (var i in n.pages)
                        _(i, n.pages) && f._eventMove.apply(n.pages[i], arguments)
                } else if (window.disableFirstMove) {
                    var n = this.data();
                    for (var i in n.pages)
                        _(i, n.pages) && f._eventEnd.apply(n.pages[i], arguments);
        ...
        _touchEnd: function(t) {
            if (null == t || null == t.target || "true" != e(t.target).attr("data-disable-events") && "true" != e(t.target).closest(".layer-action-render").attr("data-disable-events"))
                if (null == window.disableTurnEvents || 1 != window.disableTurnEvents) {
                    var i = this.data();
                    for (var n in i.pages)
                        _(n, i.pages) && f._eventEnd.apply(i.pages[n], arguments)
                } else
                    window.disableFirstMove = !0
        },
        calculateZ: function(e) {
            var t, i, n, a, s, r = this, o = this.data(), l = this.turn("view"), d = l[0] || l[1], c = e.length - 1, p = {
                pageZ: {},
                partZ: {},
                pageV: {}
            }, u = function(e) {
            ...
            for (t = 0; t <= c; t++)
                i = e[t],
                n = o.pages[i].data().f.opts.next,
                a = o.pagePlace[i],
                u(i),
                u(n),
                s = o.pagePlace[n] == n ? n : i,
                p.pageZ[s] = o.totalPages - Math.abs(d - s),
                p.partZ[a] = 2 * o.totalPages - c + t;
            return p
        },
        update: function() {
            var t, i = this.data();
            if (this.turn("animating") && 0 !== i.pageMv[0]) {
                var n, a, s = this.turn("calculateZ", i.pageMv), r = this.turn("corner"), o = this.turn("view"), l = this.turn("view", i.tpage);
                for (t in i.pageWrap)
                    _(t, i.pageWrap) && (a = i.pageObjs[t].hasClass("fixed"),
                    i.pageWrap[t].css({
                        display: s.pageV[t] || a ? "" : "none",
                        zIndex: (i.pageObjs[t].hasClass("hard") ? s.partZ[t] : s.pageZ[t]) || (a ? -1 : 0)
                    }),
                    (n = i.pages[t]) && (n.flip("z", s.partZ[t] || null),
                ...
                for (t in i.pageWrap)
                    if (_(t, i.pageWrap)) {
                        ...
                        i.pages[t] && i.pages[t].flip("disable", i.disabled || 1 != d).flip("hover", !0).flip("z", null)
                    }
            return this
        },
        _updateShadow: function() {
            var t, i, n, a = this.data(), s = this.width(), r = this.height(), o = "single" == a.display ? s : s / 2;
            t = this.turn("view"),
            a.shadow || (a.shadow = e("<div />", {
                class: "shadow",
                css: g(0, 0, 0).css
            }).appendTo(this));
            for (var l = 0; l < a.pageMv.length && (t[0] && t[1]); l++)
                t = this.turn("view", a.pages[a.pageMv[l]].data().f.opts.next),
                i = this.turn("view", a.pageMv[l]),
                t[0] = t[0] && i[0],
                t[1] = t[1] && i[1];
            switch (n = t[0] ? t[1] ? 3 : "ltr" == a.direction ? 2 : 1 : "ltr" == a.direction ? 1 : 2,
            a.shadow.removeClass("shadow-half-left"),
            a.shadow.removeClass("shadow-half-right"),
            n) {
            case 1:
                a.shadow.css({
                    width: o,
        ...
        _setPageLoc: function(e) {
            var t = this.data()
              , i = this.turn("view")
              , n = 0;
            if (e == i[0] || e == i[1] ? n = 1 : ("single" == t.display && e == i[0] + 1 || "double" == t.display && e == i[0] - 2 || e == i[1] + 2) && (n = 2),
            !this.turn("animating"))
                switch (n) {
                case 1:
                    t.pageWrap[e].css({
        ...
        options: function(t) {
            ...
            t.when)
                for (var n in t.when)
                    _(n, t.when) && this.unbind(n).bind(n, t.when[n]);
            return this
        },
        version: function() {
            return "4.1.0"
        ...
        init: function(e) {
            ...
            this.flip("options", e),
            f._addPageWrapper.call(this),
            this
        },
        setData: function(t) {
            var i = this.data();
            return i.f = e.extend(i.f, t),
            this
        },
        options: function(t) {
            var i = this.data().f;
            return t ? (f.setData.call(this, {
                opts: e.extend({}, i.opts || u, t)
            }),
            this) : i.opts
        },
        z: function(e) {
        ...
        _cAllowed: function() {
            var e = this.data().f
              ...
              , i = e.opts.turn.data()
              , n = t % 2;
            return "hard" == e.effect ? "single" == i.display && 1 != t && t != i.totalPages ? ["r", "l"] : "single" == i.display ? 1 == t ? "ltr" == i.direction ? ["r"] : ["l"] : "ltr" == i.direction ? ["l"] : ["r"] : "ltr" == i.direction ? [n ? "r" : "l"] : [n ? "l" : "r"] : "single" == i.display ? 1 == t ? "ltr" == i.direction ? l.forward : l.backward : t == i.totalPages ? "ltr" == i.direction ? l.backward : l.forward : l.all : "ltr" == i.direction ? l[n ? "forward" : "backward"] : l[n ? "backward" : "forward"]
        },
        _cornerActivated: function(t) {
            var i = this.data().f
              ...
              , r = i.opts.cornerSize;
            if (s.x <= 0 || s.y <= 0 || s.x >= n || s.y >= a)
                return !1;
            var o = f._cAllowed.call(this);
            switch (i.effect) {
            case "hard":
                if (t.isHovering && !(s.y < a / 6 || s.y >= a - a / 6))
                    return !1;
                if (s.x > n - r)
                    s.corner = "r";
                else {
        ...
        _isIArea: function(e) {
            ...
            return e = r && e.originalEvent ? e.originalEvent.touches[0] : e,
            f._cornerActivated.call(this, {
                x: e.pageX - t.left,
                y: e.pageY - t.top,
        ...
        _backGradient: function() {
            ...
            return n && !t.bshadow && (t.bshadow = e("<div/>", g(0, 0, 1)).css({
                position: "",
                width: this.width(),
                height: this.height()
            }).appendTo(t.parent)),
        ...
        resize: function(e) {
            ...
            case "sheet":
                if (e) {
                    ...
                    f._backGradient.call(this) && t.bshadow.css({
                        width: n,
                        height: a
                    })
                }
        ...
        _addPageWrapper: function() {
            ...
            !t.wrapper)
                ...
                case "hard":
                    ...
                    i.opts.gradients && (t.ashadow = e("<div/>", g(0, 0, 0)).hide().appendTo(a),
                    t.bshadow = e("<div/>", g(0, 0, 0)));
                    break;
                case "sheet":
                    var r = this.width()
                      , o = this.height();
                    Math.round(Math.sqrt(Math.pow(r, 2) + Math.pow(o, 2)));
                    if (t.fparent = t.opts.turn.data().fparent,
                    !t.fparent) {
                        var l = e("<div/>", {
                            css: {
                                "pointer-events": "none"
                        ...
                        l.data().flips = 0,
                        l.css(g(0, 0, "auto", "visible").css).appendTo(t.opts.turn),
                        t.opts.turn.data().fparent = l,
                        t.fparent = l
                    }
                    this.css({
                        position: "absolute",
                    ...
                    t.wrapper = e("<div/>", g(0, 0, this.css("z-index"))).appendTo(a).prepend(this),
                    t.fwrapper = e("<div/>", g(a.offset().top, a.offset().left)).hide().appendTo(t.fparent).addClass("fold-wrapper"),
                    t.fpage = e("<div/>", g(0, 0, 0, "visible")).css({
                        cursor: "default"
                    }).appendTo(t.fwrapper).addClass("fold-page"),
        ...
        _fold: function(e) {
            ...
            case "hard":
                ...
                var c, p, u, h, m, g = r.totalPages, v = t.opts["z-index"] || g, _ = {
                    overflow: "visible"
                }, x = o.x ? (o.x - e.x) / l : e.x / l, E = 90 * x, S = E < 90;
                switch (e.corner) {
                case "l":
                    h = "0% 50%",
                    m = "100% 50%",
                ...
                r.opts.gradients && (p ? t.ashadow.css({
                    display: "",
                    left: c,
                ...
                T(t.bshadow, w(100 * u, 0), w(100 * (1 - u), 0), [[0, "rgba(0,0,0,0.3)"], [1, "rgba(0,0,0,0)"]], 2));
                break;
            case "sheet":
                var M, C, P, A, $, z, k, O = this, I = 0, D = w(0, 0), L = w(0, 0), F = w(0, 0), H = f._foldingPage.call(this), R = (Math.tan(0),
                r.opts.acceleration), G = t.wrapper.height(), W = "t" == e.corner.substr(0, 1), N = "l" == e.corner.substr(1, 1), X = function() {
                    var t = w(0, 0)
                      , n = w(0, 0);
                    t.x = o.x ? o.x - e.x : e.x,
                    t.y = i ? o.y ? o.y - e.y : e.y : 0,
                    n.x = N ? l - t.x / 2 : e.x + t.x / 2,
                    n.y = t.y / 2;
                    var c = s - Math.atan2(t.y, t.x)
                      , p = c - Math.atan2(n.y, n.x)
                      , u = Math.max(0, Math.sin(p) * Math.sqrt(Math.pow(n.x, 2) + Math.pow(n.y, 2)));
                    if (I = c / a * 180,
                    F = w(u * Math.sin(c), u * Math.cos(c)),
                    c > s && (F.x = F.x + Math.abs(F.y * t.y / t.x),
                    F.y = 0,
                    Math.round(F.x * Math.tan(a - c)) < d))
                        return e.y = Math.sqrt(Math.pow(d, 2) + 2 * n.x * t.x),
                        W && (e.y = d - e.y),
                        X();
                    if (c > s) {
                        var h = a - c
                          , m = G - d / Math.sin(h);
                        D = w(Math.round(m * Math.cos(h)), Math.round(m * Math.sin(h))),
                        N && (D.x = -D.x),
                        W && (D.y = -D.y)
                    }
                    ...
                    var g = l - M
                      , v = g * Math.cos(2 * c)
                      , y = g * Math.sin(2 * c);
                    if (L = w(Math.round(N ? g - v : M + v), Math.round(W ? y : d - y)),
                    r.opts.gradients) {
                        $ = g * Math.sin(c);
                        ...
                        f._backGradient.call(O) && (P = w(1.2 * $ * Math.sin(c) / l * 100, 1.2 * $ * Math.cos(c) / d * 100),
                        N || (P.x = 100 - P.x),
                        W || (P.y = 100 - P.y))
                    }
                    return F.x = Math.round(F.x),
                    F.y = Math.round(F.y),
                    !0
                }, j = function(e, i, n, a) {
                    var s = ["0", "auto"]
                    ...
                    r.opts.gradients && (n[0] && (C.x = 100 - C.x),
                    n[1] && (C.y = 100 - C.y),
                    u["box-shadow"] = "0 0 20px rgba(0,0,0," + .5 * k + ")",
                    H.css(u),
                    T(t.ashadow, w(N ? 100 : 0, W ? 0 : 100), w(C.x, C.y), [[A, "rgba(0,0,0,0)"], [.8 * (1 - A) + A, "rgba(0,0,0," + .2 * z + ")"], [1, "rgba(255,255,255," + .2 * z + ")"]], 3),
                    f._backGradient.call(O) && T(t.bshadow, w(N ? 0 : 100, W ? 0 : 100), w(P.x, P.y), [[.6, "rgba(0,0,0,0)"], [.8, "rgba(0,0,0," + .3 * z + ")"], [1, "rgba(0,0,0,0)"]], 3))
                };
                switch (e.corner) {
                case "l":
                case "r":
                ...
                case "tl":
                    ...
                    break;
                case "tr":
                    e.x = Math.min(e.x, l - 1),
                    X(),
                    j(w(-F.x, F.y), [0, 0, 0, 1], [0, 0], -I);
                    break;
                case "bl":
                    e.x = Math.max(e.x, 1),
                    X(),
                    j(w(F.x, -F.y), [1, 1, 0, 0], [100, 100], -I);
                    break;
                case "br":
                    e.x = Math.min(e.x, l - 1),
                    X(),
                    j(w(-F.x, -F.y), [0, 1, 1, 0], [0, 100], I)
                }
            }
            t.point = e
        },
        _moveFoldingPage: function(e) {
            ...
            if (t) {
                ...
                if (e) {
                    var s = t.opts.next;
                    if (a[s] != t.opts.page)
                        t.folding && f._moveFoldingPage.call(this, !1),
                        f._foldingPage.call(this).appendTo(t.fpage),
                        a[s] = t.opts.page,
                        t.folding = s;
                    i.turn("update")
                } else if (t.folding) {
                    if (n.pages[t.folding]) {
                        ...
                        n.pageWrap[t.folding] && n.pageObjs[t.folding].appendTo(n.pageWrap[t.folding]);
                    t.folding in a && (a[t.folding] = t.folding),
                    delete t.folding
                }
            }
        },
        _showFoldedPage: function(e, t) {
            ...
            if (i) {
                if (!s || !a.point || a.point.corner != e.corner) {
                    ...
                    if (s = !1,
                    "prevented" == E("start", this, [a.opts, r]))
                        return !1
                }
                if (t) {
                    var o = this
                    ...
                    f._fold.call(this, e),
                    n.effect && !n.effect.turning && this.animatef(!1);
                if (!s)
                    switch (a.effect) {
                    case "hard":
                        a.visible = !0,
                        f._moveFoldingPage.call(this, !0),
                        a.fpage.show(),
                        a.opts.shadows && a.bshadow.show();
                        break;
                    case "sheet":
                        a.visible = !0,
                        a.fparent.show().data().flips++,
                        f._moveFoldingPage.call(this, !0),
                        a.fwrapper.show(),
                        a.bshadow && a.bshadow.show()
                    }
                return !0
            }
            return !1
        ...
        turnPage: function(e) {
            var t = this
              ...
              , n = i.opts.turn.data();
            e = {
                corner: i.corner ? i.corner.corner : e || f._cAllowed.call(this)[0]
            };
        ...
        _eventStart: function(e) {
            ...
            if ("single" == i.data().display) {
                if (!t.corner && !t.disabled) {
                    if (this.flip("isTurning") && t.point)
                        return t.point.fit = !0,
                        "prevented" != E("released", this, [t.point]) && f.hideFoldedPage.call(this, !1),
                        void f._eventStart.call(this, e);
                    if (t.corner = f._isIArea.call(this, e),
                    t.corner && f._foldingPage.call(this))
                        return this.trigger("pressed", [t.point]),
                        f._showFoldedPage.call(this, t.corner),
                        !1;
                    t.corner = null
                }
        ...
        _eventMove: function(e) {
            var t = this.data().f;
            if (!t.disabled)
                if (e = r ? e.originalEvent.touches : [e],
                t.corner) {
                    var i = t.parent.offset();
                    t.corner.x = e[0].pageX - i.left,
                    t.corner.y = e[0].pageY - i.top,
                    f._showFoldedPage.call(this, t.corner)
                    ...
                    if (n) {
                        if ("sheet" == t.effect && 2 == n.corner.length || "hard" == t.effect) {
                            ...
                            n.x = a.x,
                            n.y = a.y,
                            f._showFoldedPage.call(this, n, !0)
                        }
                    } else
                        "hover" == t.status && (t.status = "",
                        f.hideFoldedPage.call(this, !0))
                }
        },
        _eventEnd: function() {
            var e = this.data().f
              , t = e.corner;
            !e.disabled && t && "prevented" != E("released", this, [e.point || t]) && f.hideFoldedPage.call(this, !0),
            e.corner = null
        },
        disable: function(e) {
            return f.setData.call(this, {
                disabled: e
            }),
            this
        },
        ...
        peel: function(t, i) {
            var n = this.data().f;
            if (t) {
                if (-1 == e.inArray(t, l.all))
                    throw S("Corner " + t + " is not permitted");
                if (-1 != e.inArray(t, f._cAllowed.call(this))) {
                    var a = f._c.call(this, t, n.opts.cornerSize / 2);
                    n.status = "peel",
                    f._showFoldedPage.call(this, {
                        corner: t,
                        x: a.x,
                        y: a.y
                    }, i)
    ...
    function m(e, t, i) {
        if (i[0] && "object" != typeof i[0]) {
            if (t[i[0]])
                return t[i[0]].apply(e, Array.prototype.slice.call(i, 1));
    ...
    function x() {
        for (var e = ["Moz", "Webkit", "Khtml", "O", "ms"], t = e.length, i = ""; t--; )
            e[t] + "Transform"in document.body.style && (i = "-" + e[t].toLowerCase() + "-");
        return i
    }
    function T(e, t, i, a, s) {
        ...
        if ("-webkit-" == n) {
            for (r = 0; r < s; r++)
                o.push("color-stop(" + a[r][0] + ", " + a[r][1] + ")");
            e.css({
                "background-image": "-webkit-gradient(linear, " + t.x + "% " + t.y + "%," + i.x + "% " + i.y + "%, " + o.join(",") + " )"
            })
        } else {
            t = {
                x: t.x / 100 * e.width(),
            ...
            for (r = 0; r < s; r++)
                o.push(" " + a[r][1] + " " + 100 * (b + h * a[r][0]) / u + "%");
            e.css({
                "background-image": n + "linear-gradient(" + -c + "rad," + o.join(",") + ")"
            })
        }
    }
    function E(t, i, n) {
        var a = e.Event(t);
        return i.trigger(a, n),
        a.isDefaultPrevented() ? "prevented" : a.isPropagationStopped() ? "stopped" : ""
    }
    function S(e) {
        function t(e) {
            this.name = "TurnJsError",
    ...
    e.extend(e.fn, {
        ...
        transform: function(e, t) {
            var i = {};
            return t && (i[n + "transform-origin"] = t),
            i[n + "transform"] = e,
            this.css(i)
        },
        animatef: function(t) {
            var i = this.data();
            if (i.effect && i.effect.stop(),
            t) {
                t.to.length || (t.to = [t.to]),
                t.from.length || (t.from = [t.from]);
                for (var n = [], a = t.to.length, s = !0, r = this, o = (new Date).getTime(), l = function() {
                    if (i.effect && s) {
                        for (var e = [], d = Math.min(t.duration, (new Date).getTime() - o), c = 0; c < a; c++)
                            e.push(i.effect.easing(1, d, t.from[c], n[c], t.duration));
                        t.frame(1 == a ? e[0] : e),
                        d == t.duration ? (delete i.effect,
                        r.data(i),
                        t.complete && t.complete()) : window.requestAnim(l)
                    }
                }, d = 0; d < a; d++)
...
function(e) {
    ...
    var t, i, n = ["wheel", "mousewheel", "DOMMouseScroll", "MozMousePixelScroll"], a = "onwheel"in window.document || 9 <= window.document.documentMode ? ["wheel"] : ["mousewheel", "DomMouseScroll", "MozMousePixelScroll"], s = Array.prototype.slice;
    if (e.event.fixHooks)
    ...
    var o = e.event.special.mousewheel = {
        ...
        teardown: function() {
            if (this.removeEventListener)
                for (var t = a.length; t; )
                    this.removeEventListener(a[--t], l, !1);
            else
    ...
    function l(n) {
        var a, r = n || window.event, l = s.call(arguments, 1), p = 0, u = 0, h = 0;
        ...
        "axis"in r && r.axis === r.HORIZONTAL_AXIS && (u = -1 * h,
        h = 0),
        p = 0 === h ? u : h,
        ...
        0 !== h || 0 !== u) {
            ...
            if (a = Math.max(Math.abs(h), Math.abs(u)),
            (!i || a < i) && c(r, i = a) && (i /= 40),
            c(r, a) && (p /= 40,
            u /= 40,
            h /= 40),
            ...
            o.settings.normalizeOffset && this.getBoundingClientRect) {
                ...
                n.offsetX = n.clientX - g.left,
                n.offsetY = n.clientY - g.top
            }
            return n.deltaX = u,
            n.deltaY = h,
            n.deltaFactor = i,
...
var scaler = {
    getObjectFitSize: function(e, t, i, n, a) {
        var s = n / a
          ...
          , o = 0
          , l = 0;
        return (e ? s > r : s < r) ? l = (o = t) / s : o = (l = i) * s,
        {
            width: o,
            height: l,
            x: (t - o) / 2,
        ...
        1: [function(e, t, i) {
            ...
            t.exports = function() {
                ...
                if (!navigator.userAgent.match(/iphone|ipod|ipad/i))
                    ...
                    ;
                var e, t = Math.abs(window.orientation), i = {
                    w: 0,
                    h: 0
                };
                return (e = document.createElement("div")).style.position = "fixed",
    ...
    return function(e) {
        if (e) {
            ...
            : function() {}
              ...
              , y = function(e) {
                e.observeMutations && (e.observer = new MutationObserver(m(e, 1)),
              ...
              , x = function() {
                e.clearTimeout(_),
                _ = e.setTimeout(r(2), S.observeWindowDelay)
            }
              , T = ["resize", "orientationchange"];
            return Object.defineProperty(S, "observeWindow", {
                set: function(t) {
...
$.fitWidth = function(e, t) {
    if (null == e && $("[data-fit-text]").each((function() {
        let e = {};
    ...
    "refitAll" == e && $(document).find("[data-fit-text]").each((function(e, t) {
        fitty(t, {
            multiLine: !1,
            minSize: 8,
            maxSize: 17
...
$.cssToObject = function(e) {
    let t = {};
    return e.replace(/(?:^|;)\s*([^:]+)\s*:\s*([^;]+)\s*/g, ( (e, i, n) => t[i] = n)),
    t
}
,
function(e, t) {
    ...
    const c = {
        ...
        off: function() {
            ...
            for (let e = 0; e < o.length; e += 1) {
                ...
                for (let e = 0; e < this.length; e += 1) {
                    const i = this[e];
                    let n;
                    if (!a && i.dom7Listeners ? n = i.dom7Listeners[t] : a && i.dom7LiveListeners && (n = i.dom7LiveListeners[t]),
                    n && n.length)
                        for (let e = n.length - 1; e >= 0; e -= 1) {
                            const a = n[e];
                            s && a.listener === s || s && a.listener && a.listener.dom7proxy && a.listener.dom7proxy === s ? (i.removeEventListener(t, a.proxyListener, r),
                            n.splice(e, 1)) : s || (i.removeEventListener(t, a.proxyListener, r),
                            n.splice(e, 1))
                        }
                }
            }
            ...
            for (let t = 0; t < a.length; t += 1) {
                ...
                for (let t = 0; t < this.length; t += 1) {
                    ...
                    if (e.CustomEvent) {
                        ...
                        a.dom7EventData = i.filter(( (e, t) => t > 0)),
                        a.dispatchEvent(t),
                        a.dom7EventData = [],
        ...
        parent: function(e) {
            const t = [];
            for (let i = 0; i < this.length; i += 1)
                null !== this[i].parentNode && (e ? d(this[i].parentNode).is(e) && t.push(this[i].parentNode) : t.push(this[i].parentNode));
            return d(t)
        },
        parents: function(e) {
            const t = [];
    ...
    function h(e, t) {
        ...
        return i.WebKitCSSMatrix ? (a = o.transform || o.webkitTransform,
        a.split(",").length > 6 && (a = a.split(", ").map((e => e.replace(",", "."))).join(", ")),
        r = new i.WebKitCSSMatrix("none" === a ? "" : a)) : (r = o.MozTransform || o.OTransform || o.MsTransform || o.msTransform || o.transform || o.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,"),
        n = r.toString().split(",")),
        ...
        for (let i = 1; i < arguments.length; i += 1) {
            ...
            if (null != n && !m(n)) {
                ...
                for (let t = 0, a = i.length; t < a; t += 1) {
                    ...
                    void 0 !== s && s.enumerable && (f(e[a]) && f(n[a]) ? n[a].__swiper__ ? e[a] = n[a] : g(e[a], n[a]) : !f(e[a]) && f(n[a]) ? (e[a] = {},
                    n[a].__swiper__ ? e[a] = n[a] : g(e[a], n[a])) : e[a] = n[a])
                }
            }
        }
        return e
    ...
    function T(e) {
        ...
        b || (b = function(e) {
            ...
            const u = r.match(/(iPod)(.*OS\s([\d_]+))?/)
              ...
              , f = "Win32" === a;
            let m = "MacIntel" === a;
            return !p && m && i.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${l}x${d}`) >= 0 && (p = r.match(/(Version)\/([\d.]+)/),
            p || (p = [0, 1, "13_0_0"]),
            m = !1),
            c && !f && (o.os = "android",
            o.android = !0),
    ...
    var M = {
        ...
        updateSlides: function() {
            ...
            for (let a = 0; a < p; a += 1) {
                S = 0;
                const r = c.eq(a);
                if (E && e.grid.updateSlide(a, r, p, t),
                "none" !== r.css("display")) {
                    if ("auto" === n.slidesPerView) {
                        ...
                        n.roundLengths && (S = Math.floor(S)),
                        c[a] && (c[a].style[t("width")] = `${S}px`);
                    c[a] && (c[a].swiperSlideSize = S),
                    f.push(S),
                    n.centeredSlides ? (_ = _ + S / 2 + x / 2 + b,
                    0 === x && 0 !== a && (_ = _ - s / 2 - b),
                    0 === a && (_ = _ - s / 2 - b),
                    Math.abs(_) < .001 && (_ = 0),
                    ...
                    (T - Math.min(e.params.slidesPerGroupSkip, T)) % e.params.slidesPerGroup == 0 && u.push(_),
                    h.push(_),
                    _ = _ + S + b),
                    e.virtualSize += S + b,
                    x = S,
        ...
        updateSlidesClasses: function() {
            ...
            i.loop && (o.hasClass(i.slideDuplicateClass) ? n.children(`.${i.slideClass}:not(.${i.slideDuplicateClass})[data-swiper-slide-index="${s}"]`).addClass(i.slideDuplicateActiveClass) : n.children(`.${i.slideClass}.${i.slideDuplicateClass}[data-swiper-slide-index="${s}"]`).addClass(i.slideDuplicateActiveClass));
        ...
        updateActiveIndex: function(e) {
            ...
            if (void 0 === c) {
                for (let e = 0; e < n.length; e += 1)
                    void 0 !== n[e + 1] ? i >= n[e] && i < n[e + 1] - (n[e + 1] - n[e]) / 2 ? c = e : i >= n[e] && i < n[e + 1] && (c = e + 1) : i >= n[e] && (c = e);
    ...
    var C = {
        ...
        translateTo: function(e, t, i, n, a) {
            ...
            s.setTranslate(c),
            i && (s.emit("beforeTransitionStart", t, a),
    ...
    function P(e) {
        ...
        let o = n;
        if (o || (o = s > r ? "next" : s < r ? "prev" : "reset"),
        t.emit(`transition${a}`),
        i && s !== r) {
            if ("reset" === o)
    ...
    var A = {
        slideTo: function(e, t, i, n, a) {
            ...
            if (s.animating && o.preventInteractionOnTransition || !f && !n && !a)
                return !1;
            const m = Math.min(s.params.slidesPerGroupSkip, r);
            let g = m + Math.floor((r - m) / s.params.slidesPerGroup);
            g >= l.length && (g = l.length - 1),
            (p || o.initialSlide || 0) === (c || 0) && i && s.emit("beforeSlideChangeStart");
            const v = -l[g];
            ...
            0 === t ? s.transitionEnd(i, y) : s.animating || (s.animating = !0,
        ...
        slidePrev: function(e, t, i) {
            ...
            "auto" === a.slidesPerView && 1 === a.slidesPerGroup && a.slidesPerGroupAuto && (f = f - n.slidesPerViewDynamic("previous", !0) + 1,
            f = Math.max(f, 0))),
    ...
    var $ = {
        loopCreate: function() {
            ...
            for (let e = 0; e < l.length; e += 1)
                s.append(d(l[e].cloneNode(!0)).addClass(i.slideDuplicateClass));
            for (let e = o.length - 1; e >= 0; e -= 1)
                s.prepend(d(o[e].cloneNode(!0)).addClass(i.slideDuplicateClass))
        },
        loopFix: function() {
            const e = this;
    ...
    function z(e) {
        ...
        "touchstart" !== p.type) {
            ...
            i.activeElement && d(i.activeElement).is(r.focusableElements) && i.activeElement !== h[0] && i.activeElement.blur();
    ...
    function k(e) {
        ...
        !a.isTouched)
            return void (a.startMoving && a.isScrolling && i.emit("touchMoveOpposite", c));
        ...
        if (c.preventedByNestedSwiper)
            ...
            void (r.startY = f);
        if (!i.allowTouchMove)
            return d(c.target).is(a.focusableElements) || (i.allowClick = !1),
        ...
        if (a.isTouchEvent && s.touchReleaseOnEdges && !s.loop)
            if (i.isVertical()) {
                ...
                return;
        if (a.isTouchEvent && t.activeElement && c.target === t.activeElement && d(c.target).is(a.focusableElements))
            return a.isMoved = !0,
            void (i.allowClick = !1);
        if (a.allowTouchCallbacks && i.emit("touchMove", c),
        ...
        if (void 0 === a.isScrolling) {
            let e;
            i.isHorizontal() && r.currentY === r.startY || i.isVertical() && r.currentX === r.startX ? a.isScrolling = !1 : m * m + g * g >= 25 && (e = 180 * Math.atan2(Math.abs(g), Math.abs(m)) / Math.PI,
            a.isScrolling = i.isHorizontal() ? e > s.touchAngle : 90 - e > s.touchAngle)
        }
        if (a.isScrolling && i.emit("touchMoveOpposite", c),
        ...
        a.isMoved || (s.loop && !s.cssMode && i.loopFix(),
        ...
        v > 0 && a.currentTranslate > i.minTranslate() ? (w = !1,
        s.resistance && (a.currentTranslate = i.minTranslate() - 1 + (-i.minTranslate() + a.startTranslate + v) ** y)) : v < 0 && a.currentTranslate < i.maxTranslate() && (w = !1,
        s.resistance && (a.currentTranslate = i.maxTranslate() + 1 - (i.maxTranslate() - a.startTranslate - v) ** y)),
    ...
    function O(e) {
        ...
        if (t.allowClick) {
            ...
            t.emit("tap click", l),
            c < 300 && d - i.lastClickTime < 300 && t.emit("doubleTap doubleClick", l)
        }
        ...
        i.isMoved = !1,
        i.startMoving = !1,
        h = n.followFinger ? s ? t.translate : -t.translate : -i.currentTranslate,
        n.cssMode)
            return;
        ...
        if (c > n.longSwipesMs) {
            ...
            if (!n.shortSwipes)
                return void t.slideTo(t.activeIndex);
            t.navigation && (l.target === t.navigation.nextEl || l.target === t.navigation.prevEl) ? l.target === t.navigation.nextEl ? t.slideTo(f + y) : t.slideTo(f) : ("next" === t.swipeDirection && t.slideTo(null !== g ? g : f + y),
    ...
    const R = (e, t) => {
        const i = n()
          ...
          , u = t;
        if (d.touch) {
            const t = !("touchstart" !== s.start || !d.passiveListener || !a.passiveListeners) && {
                passive: !0,
                capture: !1
            };
            r[p](s.start, e.onTouchStart, t),
            r[p](s.move, e.onTouchMove, d.passiveListener ? {
                passive: !1,
                capture: c
            } : c),
            ...
            i[p](s.move, e.onTouchMove, c),
            i[p](s.end, e.onTouchEnd, !1);
    ...
    var G = {
        attachEvents: function() {
            ...
            e.onClick = D.bind(e),
            a.touch && !F && (t.addEventListener("touchstart", H),
            F = !0),
            R(e, "on")
        },
    ...
    const B = {
        ...
        breakpoints: {
            setBreakpoint: function() {
                ...
                const l = (o in r ? r[o] : void 0) || e.originalParams
                  ...
                  , c = W(e, l)
                  , p = a.enabled;
                d && !c ? (s.removeClass(`${a.containerModifierClass}grid ${a.containerModifierClass}grid-column`),
                e.emitContainerClasses()) : !d && c && (s.addClass(`${a.containerModifierClass}grid`),
        ...
        images: {
            loadImage: function(e, t, i, n, a, r) {
                ...
                d(e).parent("picture")[0] || e.complete && a ? c() : t ? (l = new o.Image,
                l.onload = c,
                l.onerror = c,
                n && (l.sizes = n),
                i && (l.srcset = i),
    ...
    function ae(e, t, i) {
        ...
        let s = a.children(`.${n}`);
        return s.length || (s = d(`<div class="swiper-slide-shadow${i ? `-${i}` : ""}"></div>`),
        a.append(s)),
        s
    }
            ...
            t.params.resizeObserver && void 0 !== a.ResizeObserver ? t && !t.destroyed && t.initialized && (r = new ResizeObserver((e => {
                o = a.requestAnimationFrame(( () => {
                    ...
                    e.forEach((e => {
                        ...
                        r && r !== t.el || (a = n ? n.width : (i[0] || i).inlineSize,
    ...
    const se = [function(e) {
        let t, {swiper: i, extendParams: n, on: a, emit: s} = e;
        function r(e, t) {
        ...
        function o(e) {
            ...
            d === w && c === y && !e)
                return i.slidesGrid !== u && b !== h && i.slides.css(m, `${b}px`),
                i.updateProgress(),
            ...
            if (e)
                ...
                for (let e = d; e <= c; e += 1)
                    (e < w || e > y) && i.$wrapperEl.find(`.${i.params.slideClass}[data-swiper-slide-index="${e}"]`).remove();
            for (let t = 0; t < p.length; t += 1)
                t >= w && t <= y && (void 0 === c || e ? T.push(t) : (t > c && T.push(t),
                t < d && x.push(t)));
            T.forEach((e => {
            ...
            prependSlide: function(e) {
                ...
                if (i.params.virtual.cache) {
                    ...
                    Object.keys(e).forEach((i => {
                        ...
                        s && n.attr("data-swiper-slide-index", parseInt(s, 10) + a),
                        t[parseInt(i, 10) + a] = n
                    }
                    )),
                    i.virtual.cache = t
    ...
    , function(e) {
        ...
        function c(e) {
            ...
            if (!(n.shiftKey || n.altKey || n.ctrlKey || n.metaKey || o.activeElement && o.activeElement.nodeName && ("input" === o.activeElement.nodeName.toLowerCase() || "textarea" === o.activeElement.nodeName.toLowerCase()))) {
                if (t.params.keyboard.onlyInViewport && (d || c || p || u || h || f)) {
                    ...
                    const c = [[d.left, d.top], [d.left + a, d.top], [d.left, d.top + s], [d.left + a, d.top + s]];
                ...
                t.isHorizontal() ? ((d || c || p || u) && (n.preventDefault ? n.preventDefault() : n.returnValue = !1),
                ((c || u) && !i || (d || p) && i) && t.slideNext(),
                ((d || p) && !i || (c || u) && i) && t.slidePrev()) : ((d || c || h || f) && (n.preventDefault ? n.preventDefault() : n.returnValue = !1),
                (c || f) && t.slideNext(),
                (d || h) && t.slidePrev()),
                r("keyPress", a)
            }
        ...
        function p() {
            t.keyboard.enabled || (d(o).on("keydown", c),
            t.keyboard.enabled = !0)
        }
        function u() {
            t.keyboard.enabled && (d(o).off("keydown", c),
    ...
    , function(e) {
        ...
        function v(e) {
            ...
            !t.mouseEntered && !r[0].contains(i.target) && !s.releaseOnEdges)
                return !0;
            ...
            if (s.forceToAxis)
                ...
                c = Math.abs(m.pixelX) > Math.abs(m.pixelY) ? -m.pixelX * f : -m.pixelY;
            if (0 === c)
                return !0;
            s.invert && (c = -c);
    ...
    , function(e) {
        ...
        function p() {
            ...
            "bullets" === i.type && t.pagination.bullets && t.pagination.bullets.length > 0) {
                ...
                let a, l, u;
                if (i.dynamicBullets && (r = n.eq(0)[t.isHorizontal() ? "outerWidth" : "outerHeight"](!0),
                s.css(t.isHorizontal() ? "width" : "height", r * (i.dynamicMainBullets + 4) + "px"),
                i.dynamicMainBullets > 1 && void 0 !== t.previousIndex && (o += p - (t.previousIndex - t.loopedSlides || 0),
                ...
                s.length > 1)
                    n.each((e => {
                        ...
                        i.dynamicBullets && (n >= a && n <= l && t.addClass(`${i.bulletActiveClass}-main`),
                        n === a && c(t, "prev"),
                        n === l && c(t, "next"))
                    }
                    ));
            ...
            if ("fraction" === i.type && (s.find(U(i.currentClass)).text(i.formatFractionCurrent(p + 1)),
            s.find(U(i.totalClass)).text(i.formatFractionTotal(u))),
            "progressbar" === i.type) {
                let e;
                ...
                s.find(U(i.progressbarFillClass)).transform(`translate3d(0,0,0) scaleX(${a}) scaleY(${r})`).transition(t.params.speed)
            }
            "custom" === i.type && i.renderCustom ? (s.html(i.renderCustom(t, p + 1, u)),
            a("paginationRender", s[0])) : a("paginationUpdate", s[0]),
        ...
        function u() {
            ...
            if ("bullets" === e.type) {
                ...
                for (let i = 0; i < a; i += 1)
                    e.renderBullet ? s += e.renderBullet.call(t, i, e.bulletClass) : s += `<${e.bulletElement} class="${e.bulletClass}"></${e.bulletElement}>`;
                n.html(s),
        ...
        function h() {
            ...
            i.length > 1 && (i = i.filter((e => d(e).parents(".swiper")[0] === t.el)))),
            ...
            e.clickable && i.on("click", U(e.bulletClass), (function(e) {
                e.preventDefault();
    ...
    , function(e) {
        ...
        function y(e) {
            const {scrollbar: i, rtlTranslate: n} = t
              , {$el: a} = i;
            let s;
            s = (w(e) - a.offset()[t.isHorizontal() ? "left" : "top"] - (null !== o ? o : l / 2)) / (c - l),
        ...
        function T(e) {
            ...
            const d = l[0]
              ...
              , p = !(!o.passiveListener || !s.passiveListeners) && {
                passive: !0,
                capture: !1
            };
            if (!d)
            ...
            o.touch ? (d[u](n.start, b, c),
            d[u](n.move, _, c),
            d[u](n.end, x, p)) : (d[u](a.start, b, c),
            r[u](a.move, _, c),
            r[u](a.end, x, p))
        }
        function E() {
            ...
            a.addClass(t.isHorizontal() ? n.horizontalClass : n.verticalClass);
            let s = a.find(`.${t.params.scrollbar.dragClass}`);
            0 === s.length && (s = d(`<div class="${t.params.scrollbar.dragClass}"></div>`),
            a.append(s)),
            Object.assign(e, {
                $el: a,
                el: a[0],
        ...
        a("init", ( () => {
            !1 === t.params.scrollbar.enabled ? M() : (E(),
            v(),
            g())
        }
        )),
    ...
    , function(e) {
        ...
        function y(e) {
            ...
            f.$slideEl && f.$slideEl.length || (f.$slideEl = d(e.target).closest(`.${t.params.slideClass}`),
        ...
        function b(e) {
            ...
            f.$imageEl && 0 !== f.$imageEl.length ? (i.gestures ? a.scale = e.scale * p : a.scale = f.scaleMove / f.scaleStart * p,
            ...
            f.$imageEl.transform(`translate3d(0,0,0) scale(${a.scale})`)) : "gesturechange" === e.type && y(e)
        }
        function _(e) {
            const i = t.device
              , n = t.support
            ...
            f.$imageEl && 0 !== f.$imageEl.length && (s.scale = Math.max(Math.min(s.scale, f.maxRatio), a.minRatio),
        ...
        function E(e) {
            const i = t.zoom
              , n = t.params.zoom;
            if (f.$slideEl || (e && e.target && (f.$slideEl = d(e.target).closest(`.${t.params.slideClass}`)),
            ...
            void 0 === m.touchesStart.x && e ? (a = "touchend" === e.type ? e.changedTouches[0].pageX : e.pageX,
            s = "touchend" === e.type ? e.changedTouches[0].pageY : e.pageY) : (a = m.touchesStart.x,
            s = m.touchesStart.y),
            i.scale = f.$imageWrapEl.attr("data-swiper-zoom") || n.maxRatio,
            p = f.$imageWrapEl.attr("data-swiper-zoom") || n.maxRatio,
            e ? (S = f.$slideEl[0].offsetWidth,
        ...
        function A(e) {
            ...
            t.$wrapperEl[e]("gesturechange", n, b, i),
            t.$wrapperEl[e]("gestureend", n, _, i)
        }
        function $() {
            o || (o = !0,
            A("on"))
        ...
        function k() {
            ...
            const i = t.support
              ...
              , s = P();
            i.gestures ? (t.$wrapperEl.on(t.touchEvents.start, $, n),
            t.$wrapperEl.on(t.touchEvents.end, z, n)) : "touchstart" === t.touchEvents.start && (t.$wrapperEl.on(t.touchEvents.start, s, y, n),
            t.$wrapperEl.on(t.touchEvents.move, s, b, a),
            t.$wrapperEl.on(t.touchEvents.end, s, _, n),
            t.touchEvents.cancel && t.$wrapperEl.on(t.touchEvents.cancel, s, _, n)),
        ...
        function O() {
            ...
            const {passiveListener: n, activeListenerWithCapture: a} = C()
              , s = P();
            i.gestures ? (t.$wrapperEl.off(t.touchEvents.start, $, n),
            t.$wrapperEl.off(t.touchEvents.end, z, n)) : "touchstart" === t.touchEvents.start && (t.$wrapperEl.off(t.touchEvents.start, s, y, n),
        ...
        n("touchStart", ( (e, i) => {
            t.zoom.enabled && function(e) {
                const i = t.device;
                f.$imageEl && 0 !== f.$imageEl.length && (m.isTouched || (i.android && e.cancelable && e.preventDefault(),
                m.isTouched = !0,
        ...
        n("touchEnd", ( (e, i) => {
            t.zoom.enabled && function() {
                ...
                const a = g.x * i
                  ...
                  , r = g.y * n
                  , o = m.currentY + r;
                0 !== g.x && (i = Math.abs((s - m.currentX) / g.x)),
        ...
        Object.assign(t.controller, {
            setTranslate: function(e, i) {
                ...
                function l(e) {
                    ...
                    r && "container" !== t.params.controller.by || (s = (e.maxTranslate() - e.minTranslate()) / (t.maxTranslate() - t.minTranslate()),
            ...
            setTransition: function(e, i) {
                ...
                function r(i) {
                    ...
                    i.$wrapperEl.transitionEnd(( () => {
                        a && (i.params.loop && "slide" === t.params.controller.by && i.loopFix(),
                        i.transitionEnd())
                    }
                    )))
                }
                if (Array.isArray(a))
                    for (s = 0; s < a.length; s += 1)
                        a[s] !== i && a[s]instanceof n && r(a[s]);
                else
                    a instanceof n && i !== a && r(a)
            }
        })
    }
    , function(e) {
        ...
        const v = (e, t, i) => {
          ...
          , y = () => {
            ...
            e.slideLabelMessage && t.slides.each(( (n, a) => {
                const s = d(n)
          ...
          , b = () => {
            ...
            const n = t.$wrapperEl
              , s = e.id || n.attr("id") || `swiper-wrapper-${r = 16,
            void 0 === r && (r = 16),
        ...
        n("fromEdge toEdge afterInit lock unlock", ( () => {
            t.params.a11y.enabled && function() {
                if (t.params.loop || t.params.rewind || !t.navigation)
                    return;
                const {$nextEl: e, $prevEl: i} = t.navigation;
                i && i.length > 0 && (t.isBeginning ? (u(i),
                o(i)) : (h(i),
                r(i))),
        ...
        n("paginationUpdate", ( () => {
            t.params.a11y.enabled && function() {
                ...
                m() && t.pagination.bullets.each((i => {
                    const n = d(i);
                    t.params.pagination.clickable && (r(n),
                    t.params.pagination.renderBullet || (l(n, "button"),
                    p(n, e.paginationBulletMessage.replace(/\{\{index\}\}/, n.index() + 1)))),
    ...
    , function(e) {
        let t, {swiper: i, extendParams: a, on: s, emit: r} = e;
        function o() {
            ...
            t = p(( () => {
                ...
                r("autoplay")) : i.isBeginning ? i.params.autoplay.stopOnLastSlide ? d() : (e = i.slideTo(i.slides.length - 1, i.params.speed, !0, !0),
                r("autoplay")) : (e = i.slidePrev(i.params.speed, !0, !0),
                r("autoplay")) : i.params.loop ? (i.loopFix(),
                e = i.slideNext(i.params.speed, !0, !0),
                r("autoplay")) : i.isEnd ? i.params.autoplay.stopOnLastSlide ? d() : (e = i.slideTo(0, i.params.speed, !0, !0),
                r("autoplay")) : (e = i.slideNext(i.params.speed, !0, !0),
                r("autoplay")),
        ...
        function f() {
            i.params.autoplay.disableOnInteraction ? d() : (r("autoplayPause"),
            c()),
        ...
        s("init", ( () => {
            if (i.params.autoplay.enabled) {
                ...
                i.params.autoplay.pauseOnMouseEnter && (i.$el.on("mouseenter", f),
    ...
    , function(e) {
        ...
        function r() {
            ...
            const i = e.clickedIndex
              , n = e.clickedSlide;
            if (n && d(n).hasClass(t.params.thumbs.slideThumbActiveClass))
                return;
            if (null == i)
                return;
            let a;
            if (a = e.params.loop ? parseInt(d(e.clickedSlide).attr("data-swiper-slide-index"), 10) : i,
            t.params.loop) {
                let e = t.activeIndex;
        ...
        function l(e) {
            ...
            i.params.loop || i.params.virtual && i.params.virtual.enabled)
                for (let e = 0; e < r; e += 1)
                    i.$wrapperEl.children(`[data-swiper-slide-index="${t.realIndex + e}"]`).addClass(o);
            else
                for (let e = 0; e < r; e += 1)
                    ...
                    if (i < -t.minTranslate())
                        ...
                        if (s.freeMode.momentum) {
                            if (d.velocities.length > 1) {
                                ...
                                (a > 150 || u() - e.time > 300) && (t.velocity = 0)
                            } else
                                t.velocity = 0;
                            ...
                            let m;
                            if (c < t.maxTranslate())
                                s.freeMode.momentumBounce ? (c + t.maxTranslate() < -f && (c = t.maxTranslate() - f),
                                p = t.maxTranslate(),
                                h = !0,
                                d.allowMomentumBounce = !0) : c = t.maxTranslate(),
                                s.loop && s.centeredSlides && (m = !0);
                            else if (c > t.minTranslate())
                                s.freeMode.momentumBounce ? (c - t.minTranslate() > f && (c = t.minTranslate() + f),
                                p = t.minTranslate(),
                                h = !0,
    ...
    , function(e) {
        let t, i, n, {swiper: a, extendParams: s} = e;
        s({
            grid: {
                rows: 1,
                fill: "column"
        ...
        a.grid = {
            ...
            updateWrapperSize: (e, i, n) => {
                ...
                a.virtualSize = Math.ceil(a.virtualSize / l) - s,
                a.$wrapperEl.css({
                    [n("width")]: `${a.virtualSize + s}px`
                }),
                r) {
                    i.splice(0, i.length);
                    const e = [];
                    for (let t = 0; t < i.length; t += 1) {
                        let n = i[t];
                        o && (n = Math.floor(n)),
                        i[t] < a.virtualSize + i[0] && e.push(n)
                    }
                    i.push(...e)
                }
            }
    ...
    , function(e) {
        ...
        const a = (e, t, i) => {
            ...
            0 === n.length && (n = d(`<div class="swiper-slide-shadow-${i ? "left" : "top"}"></div>`),
            e.append(n)),
            0 === a.length && (a = d(`<div class="swiper-slide-shadow-${i ? "right" : "bottom"}"></div>`),
            e.append(a)),
        ...
        te({
            ...
            setTranslate: () => {
                ...
                let f, m = 0;
                p.shadow && (u ? (f = i.find(".swiper-cube-shadow"),
                0 === f.length && (f = d('<div class="swiper-cube-shadow"></div>'),
                i.append(f)),
                f.css({
                    height: `${s}px`
                ...
                p.shadow)
                    if (u)
                        f.transform(`translate3d(0px, ${s / 2 + p.shadowOffset}px, ${-s / 2}px) rotateX(90deg) rotateZ(0deg) scale(${p.shadowScale})`);
                    else {
                ...
                i.transform(`translate3d(0px,0,${g}px) rotateX(${t.isHorizontal() ? 0 : m}deg) rotateY(${t.isHorizontal() ? -m : 0}deg)`),
        ...
        te({
            ...
            recreateShadows: () => {
                ...
                t.slides.each((i => {
                    const n = d(i);
                    let s = n[0].progress;
                    t.params.flipEffect.limitRotation && (s = Math.max(Math.min(i.progress, 1), -1)),
                    a(n, s, e)
                }
                ))
            }
            ...
            setTranslate: () => {
                ...
                for (let i = 0; i < e.length; i += 1) {
                    ...
                    if (f && m.shadow || !f) {
                        ...
                        if (0 === e.length && m.shadow && (e = ae(s, n)),
                        e.length) {
...
function(e, t, i, n) {
    ...
    function s(e, t, i) {
        return !!Array.isArray(e) && (r(e, i[t], i),
        !0)
    }
    function r(e, t, i) {
        var a;
    ...
    function o(t, i, n) {
        ...
        return function() {
            ...
            return s && s.call(e.console, a, n),
            t.apply(this, arguments)
        }
    }
    function l(e, t, i) {
        var n, a = t.prototype;
        (n = e.prototype = Object.create(a)).constructor = e,
        n._super = a,
        i && ne(n, i)
    }
    function d(e, t) {
    ...
    function T(e, t, i) {
        ...
        function(e, t) {
            var i = e.session
              , n = t.pointers
              , a = n.length;
            i.firstInput || (i.firstInput = S(t)),
            a > 1 && !i.firstMultiple ? i.firstMultiple = S(t) : 1 === a && (i.firstMultiple = !1);
            var s = i.firstInput
              , r = i.firstMultiple
            ...
            function(e, t) {
                var i = t.center
                  ...
                  , a = e.prevDelta || {}
                  , s = e.prevInput || {};
                t.eventType !== ye && s.eventType !== _e || (a = e.prevDelta = {
                    x: s.deltaX || 0,
                    y: s.deltaY || 0
                },
                n = e.offsetDelta = {
    ...
    function E(e, t) {
        var i, a, s, r, o = e.lastInterval || t, l = t.timeStamp - o.timeStamp;
    ...
    function S(e) {
        for (var t = [], i = 0; i < e.pointers.length; )
            t[i] = {
                clientX: oe(e.pointers[i].clientX),
                clientY: oe(e.pointers[i].clientY)
            },
            i++;
        return {
            timeStamp: de(),
    ...
    function I(e, t) {
        ...
        return t & (_e | xe) && (i = y(i.concat(n), "identifier", !0)),
        [i, n]
    }
    function D() {
        this.evTarget = je,
    ...
    function L(e, t) {
        ...
        t === ye)
            for (a = 0; a < s.length; )
                ...
                a++;
        for (a = 0; a < r.length; )
            n[r[a].identifier] && o.push(r[a]),
            t & (_e | xe) && delete n[r[a].identifier],
            a++;
    ...
    function F() {
        ...
        this.touch = new D(this.manager,e),
        this.mouse = new z(this.manager,e),
        this.primaryTouch = null,
        this.lastTouches = []
    }
    function H(e, t) {
        e & ye ? (this.primaryTouch = t.changedPointers[0].identifier,
        R.call(this, t)) : e & (_e | xe) && R.call(this, t)
    }
    function R(e) {
    ...
    function J(e, t) {
        return (t = t || {}).recognizers = p(t.recognizers, J.defaults.preset),
        new ee(e,t)
    }
    function ee(e, t) {
        ...
        te(this, !0),
        r(this.options.recognizers, (function(e) {
    ...
    function te(e, t) {
        var i, n = e.element;
        n.style && (r(e.options.cssProps, (function(a, s) {
            i = b(n.style, s),
            t ? (e.oldCssProps[i] = n.style[i],
            n.style[i] = a) : n.style[i] = e.oldCssProps[i] || ""
        }
        )),
        t || (e.oldCssProps = {}))
    }
    ...
    var ne, ae = ["", "webkit", "Moz", "MS", "ms", "o"], se = t.createElement("div"), re = "function", oe = Math.round, le = Math.abs, de = Date.now;
    ...
    : Object.assign;
    var ce = o((function(e, t, i) {
        for (var a = Object.keys(t), s = 0; s < a.length; )
            (!i || i && e[a[s]] === n) && (e[a[s]] = t[a[s]]),
            s++;
        return e
    }
    ), "extend", "Use `assign`.")
    ...
    x.prototype = {
        ...
        init: function() {
            ...
            this.evWin && u(_(this.element), this.evWin, this.domHandler)
        },
        destroy: function() {
    ...
    l(z, x, {
        handler: function(e) {
            ...
            t & be && 1 !== e.which && (t = _e),
            this.pressed && (t & _e && (this.pressed = !1),
    ...
    l(k, x, {
        handler: function(e) {
            ...
            a & ye && (0 === e.button || r) ? 0 > o && (t.push(e),
            o = t.length - 1) : a & (_e | xe) && (i = !0),
            0 > o || (t[o] = e,
    ...
    l(O, x, {
        handler: function(e) {
            var t = Ge[e.type];
            if (t === ye && (this.started = !0),
            this.started) {
                var i = I.call(this, e, t);
                t & (_e | xe) && i[0].length - i[1].length == 0 && (this.started = !1),
                this.callback(this.manager, t, {
                    pointers: i[0],
                    changedPointers: i[1],
                    pointerType: ge,
    ...
    W.prototype = {
        set: function(e) {
            e == Ue && (e = this.compute()),
            Ve && this.manager.element.style && tt[e] && (this.manager.element.style[qe] = e),
    ...
    N.prototype = {
        defaults: {},
        set: function(e) {
            return ne(this.options, e),
            this.manager && this.manager.touchAction.update(),
            this
        },
        recognizeWith: function(e) {
            if (s(e, "recognizeWith", this))
                return this;
            var t = this.simultaneous;
            return t[(e = B(e, this)).id] || (t[e.id] = e,
            e.recognizeWith(this)),
            this
        },
        dropRecognizeWith: function(e) {
            return s(e, "dropRecognizeWith", this) || (e = B(e, this),
            delete this.simultaneous[e.id]),
            this
        },
        requireFailure: function(e) {
            if (s(e, "requireFailure", this))
                return this;
            var t = this.requireFail;
            return -1 === v(t, e = B(e, this)) && (t.push(e),
            e.requireFailure(this)),
            this
        },
        dropRequireFailure: function(e) {
            if (s(e, "dropRequireFailure", this))
                return this;
            e = B(e, this);
        ...
        emit: function(e) {
            ...
            var i = this
              , n = this.state;
            st > n && t(i.options.event + X(n)),
            t(i.options.event),
            e.additionalEvent && t(e.additionalEvent),
            n >= st && t(i.options.event + X(n))
        },
        tryEmit: function(e) {
        ...
        recognize: function(e) {
            var t = ne({}, e);
            return c(this.options.enable, [this, t]) ? (this.state & (rt | ot | lt) && (this.state = it),
            this.state = this.process(t),
            void (this.state & (nt | at | st | ot) && this.tryEmit(t))) : (this.reset(),
            void (this.state = lt))
        },
        process: function(e) {},
    ...
    l(q, Y, {
        ...
        directionTest: function(e) {
            var t = this.options
              ...
              , s = e.deltaX
              , r = e.deltaY;
            return a & t.direction || (t.direction & Pe ? (a = 0 === s ? Te : 0 > s ? Ee : Se,
            i = s != this.pX,
            n = Math.abs(e.deltaX)) : (a = 0 === r ? Te : 0 > r ? Me : Ce,
            i = r != this.pY,
            n = Math.abs(e.deltaY))),
            e.direction = a,
    ...
    l(U, N, {
        ...
        emit: function(e) {
            this.state === rt && (e && e.eventType & _e ? this.manager.emit(this.options.event + "up", e) : (this._input.timeStamp = de(),
    ...
    l(Q, Y, {
        ...
        attrTest: function(e) {
            ...
            return i & (Pe | Ae) ? t = e.overallVelocity : i & Pe ? t = e.overallVelocityX : i & Ae && (t = e.overallVelocityY),
    ...
    l(K, N, {
        ...
        emit: function() {
            this.state == rt && (this._input.tapCount = this.count,
            this.manager.emit(this.options.event, this._input))
        }
    }),
    J.VERSION = "2.0.8",
        ...
        recognize: function(e) {
            ...
            if (!t.stopped) {
                ...
                for (var s = 0; s < n.length; )
                    ...
                    !a && i.state & (nt | at | st) && (a = t.curRecognizer = i),
                    s++
            }
        },
        get: function(e) {
...
function() {
    ...
    i.prototype = {
        ...
        play: function(e, i) {
            ...
            if ("number" == typeof e)
                ...
                !n._playLock)) {
                    for (var s = 0, r = 0; r < n._sounds.length; r++)
                        n._sounds[r]._paused && !n._sounds[r]._ended && (s++,
                        a = n._sounds[r]._id);
                    1 === s ? e = null : a = null
                }
            }
            ...
            if (!(d >= h)) {
                ...
                if (n._webAudio) {
                    ...
                    "running" === t.state && "interrupted" !== t.ctx.state ? g() : (n._playLock = !0,
                    n.once("resume", g),
                    n._clearTimer(o._id))
                } else {
                    var v = function() {
                        m.currentTime = d,
                        m.muted = o._muted || n._muted || t._muted || m.muted,
                        m.volume = o._volume * t.volume(),
                        m.playbackRate = o._rate;
                        try {
                            var a = m.play();
                            if (a && "undefined" != typeof Promise && (a instanceof Promise || "function" == typeof a.then) ? (n._playLock = !0,
                            f(),
                            a.then((function() {
                                n._playLock = !1,
                                m._unlocked = !0,
                                i ? n._loadQueue() : n._emit("play", o._id)
                            }
                            )).catch((function() {
                                n._playLock = !1,
                            ...
                            "__default" !== e || o._loop ? n._endTimers[o._id] = setTimeout(n._ended.bind(n, o), p) : (n._endTimers[o._id] = function() {
                                n._ended(o),
                                m.removeEventListener("ended", n._endTimers[o._id], !1)
                            }
                            ,
                    ...
                    if (m.readyState >= 3 || w)
                        ...
                        var y = function() {
                            n._state = "loaded",
                            v(),
                            m.removeEventListener(t._canPlayEvent, y, !1)
                        };
        ...
        pause: function(e) {
            ...
            for (var i = t._getSoundIds(e), n = 0; n < i.length; n++) {
                ...
                if (a && !a._paused && (a._seek = t.seek(i[n]),
                a._rateSeek = 0,
                a._paused = !0,
                t._stopFade(i[n]),
                a._node))
        ...
        stop: function(e, t) {
            ...
            for (var n = i._getSoundIds(e), a = 0; a < n.length; a++) {
                ...
                s._node.pause(),
                s._node.duration === 1 / 0 && i._clearSound(s._node))),
        ...
        mute: function(e, i) {
            ...
            for (var a = n._getSoundIds(i), s = 0; s < a.length; s++) {
                ...
                r && (r._muted = e,
                r._interval && n._stopFade(r._id),
                n._webAudio && r._node ? r._node.gain.setValueAtTime(e ? 0 : r._volume, t.ctx.currentTime) : r._node && (r._node.muted = !!t._muted || e),
                n._emit("mute", r._id))
            }
            return n
        },
        volume: function() {
            ...
            if (1 === s.length || 2 === s.length && void 0 === s[1]) {
                ...
                s.length >= 2 && (e = parseFloat(s[0]),
                i = parseInt(s[1], 10));
            if (!(void 0 !== e && e >= 0 && e <= 1))
                return (n = i ? a._soundById(i) : a._sounds[0]) ? n._volume : 0;
            if ("loaded" !== a._state || a._playLock)
                ...
                a;
            void 0 === i && (a._volume = e),
            i = a._getSoundIds(i);
            for (var l = 0; l < i.length; l++)
                (n = a._soundById(i[l])) && (n._volume = e,
                s[2] || a._stopFade(i[l]),
        ...
        _startFadeInterval: function(e, t, i, n, a, s) {
            ...
            e._interval = setInterval((function() {
                ...
                s && (r._volume = o),
                (i < t && o <= i || i > t && o >= i) && (clearInterval(e._interval),
                e._interval = null,
                e._fadeTo = null,
                r.volume(i, e._id),
                r._emit("fade", e._id))
        ...
        _stopFade: function(e) {
            var i = this
              , n = i._soundById(e);
            return n && n._interval && (i._webAudio && n._node.gain.cancelScheduledValues(t.ctx.currentTime),
            clearInterval(n._interval),
            n._interval = null,
            i.volume(n._fadeTo, e),
            n._fadeTo = null,
            i._emit("fade", e)),
            i
        },
        loop: function() {
            var e, t, i, n = this, a = arguments;
            if (0 === a.length)
                return n._loop;
            if (1 === a.length) {
                if ("boolean" != typeof a[0])
                    return !!(i = n._soundById(parseInt(a[0], 10))) && i._loop;
                e = a[0],
                n._loop = e
            } else
                2 === a.length && (e = a[0],
            ...
            for (var s = n._getSoundIds(t), r = 0; r < s.length; r++)
                (i = n._soundById(s[r])) && (i._loop = e,
                n._webAudio && i._node && i._node.bufferSource && (i._node.bufferSource.loop = e,
                e && (i._node.bufferSource.loopStart = i._start || 0,
                i._node.bufferSource.loopEnd = i._stop,
                n.playing(s[r]) && (n.pause(s[r], !0),
                n.play(s[r], !0)))));
            return n
        },
        rate: function() {
            ...
            if (0 === s.length)
                ...
                2 === s.length && (e = parseFloat(s[0]),
                i = parseInt(s[1], 10));
            if ("number" != typeof e)
                return (n = a._soundById(i)) ? n._rate : a._rate;
            if ("loaded" !== a._state || a._playLock)
                return a._queue.push({
                    event: "rate",
                    action: function() {
            ...
            for (var l = 0; l < i.length; l++)
                if (n = a._soundById(i[l])) {
                    a.playing(i[l]) && (n._rateSeek = a.seek(i[l]),
                    n._playStart = a._webAudio ? t.ctx.currentTime : n._playStart),
                    n._rate = e,
                    ...
                    !a._endTimers[i[l]] && n._paused || (a._clearTimer(i[l]),
                    a._endTimers[i[l]] = setTimeout(a._ended.bind(a, n), p)),
                    a._emit("rate", n._id)
                }
            return a
        },
        seek: function() {
            var e, i, n = this, a = arguments;
            if (0 === a.length)
                n._sounds.length && (i = n._sounds[0]._id);
            else if (1 === a.length) {
                var s = n._getSoundIds()
                  , r = s.indexOf(a[0]);
                r >= 0 ? i = parseInt(a[0], 10) : n._sounds.length && (i = n._sounds[0]._id,
                e = parseFloat(a[0]))
            } else
            ...
            if (o) {
                ...
                o._ended = !1,
                n._clearTimer(i),
                n._webAudio || !o._node || isNaN(o._node.duration) || (o._node.currentTime = e);
                var p = function() {
                    c && n.play(i, !0),
                    n._emit("seek", i)
                };
        ...
        duration: function(e) {
            var t = this
              , i = t._duration
              , n = t._soundById(e);
            return n && (i = t._sprite[n._sprite][1] / 1e3),
            i
        },
        state: function() {
            return this._state
        ...
        unload: function() {
            for (var e = this, i = e._sounds, n = 0; n < i.length; n++)
                ...
                e._webAudio || (e._clearSound(i[n]._node),
        ...
        on: function(e, t, i, n) {
            var a = this["_on" + e];
            return "function" == typeof t && a.push(n ? {
                id: i,
                fn: t,
                once: n
            } : {
        ...
        off: function(e, t, i) {
            ...
            t || i)
                ...
                for (s = 0; s < o.length; s++)
                    0 === o[s].indexOf("_on") && Array.isArray(n[o[s]]) && (n[o[s]] = [])
            }
            return n
        },
        once: function(e, t, i) {
        ...
        _emit: function(e, t, i) {
            for (var n = this, a = n["_on" + e], s = a.length - 1; s >= 0; s--)
                a[s].id && a[s].id !== t && "load" !== e || (setTimeout(function(e) {
                    e.call(this, t, i)
                }
                .bind(n, a[s].fn), 0),
                a[s].once && n.off(e, a[s].fn, a[s].id));
            return n._loadQueue(e),
            n
        },
        ...
        _ended: function(e) {
            ...
            !i._webAudio && a && i.stop(e._id, !0).play(e._id),
            i._webAudio && a) {
                i._emit("play", e._id),
                e._seek = e._start || 0,
                e._rateSeek = 0,
    ...
    n.prototype = {
        ...
        create: function() {
            ...
            e._node.gain.setValueAtTime(n, t.ctx.currentTime),
            e._node.paused = !0,
    ...
    var a = {}
      , s = function(e) {
        ...
        if (/^data:[^;]+;base64,/.test(t)) {
            for (var i = atob(t.split(",")[1]), n = new Uint8Array(i.length), s = 0; s < i.length; ++s)
                n[s] = i.charCodeAt(s);
            o(n.buffer, e)
        } else {
    ...
    global.Howler = t,
    global.Howl = i,
    global.Sound = n) : "undefined" != typeof window && (window.HowlerGlobal = e,
    window.Howler = t,
    window.Howl = i,
    window.Sound = n)
}(),
...
function() {
    ...
    HowlerGlobal.prototype.pos = function(e, t, i) {
        ...
        void 0 !== n.ctx.listener.positionX ? (n.ctx.listener.positionX.setTargetAtTime(n._pos[0], Howler.ctx.currentTime, .1),
    ...
    HowlerGlobal.prototype.orientation = function(e, t, i, n, a, s) {
        ...
        "number" != typeof e ? o : (r._orientation = [e, t, i, n, a, s],
        void 0 !== r.ctx.listener.forwardX ? (r.ctx.listener.forwardX.setTargetAtTime(e, Howler.ctx.currentTime, .1),
        r.ctx.listener.forwardY.setTargetAtTime(t, Howler.ctx.currentTime, .1),
        r.ctx.listener.forwardZ.setTargetAtTime(i, Howler.ctx.currentTime, .1),
        r.ctx.listener.upX.setTargetAtTime(n, Howler.ctx.currentTime, .1),
        r.ctx.listener.upY.setTargetAtTime(a, Howler.ctx.currentTime, .1),
        r.ctx.listener.upZ.setTargetAtTime(s, Howler.ctx.currentTime, .1)) : r.ctx.listener.setOrientation(e, t, i, n, a, s),
        r)
    }
    ,
    ...
    Howl.prototype.stereo = function(e, i) {
        ...
        for (var s = n._getSoundIds(i), r = 0; r < s.length; r++) {
            ...
            if (o) {
                ...
                "spatial" === a ? void 0 !== o._panner.positionX ? (o._panner.positionX.setValueAtTime(e, Howler.ctx.currentTime),
    ...
    Howl.prototype.pos = function(e, i, n, a) {
        ...
        for (var r = s._getSoundIds(a), o = 0; o < r.length; o++) {
            ...
            if (l) {
                ...
                l._panner.positionZ.setValueAtTime(n, Howler.ctx.currentTime)) : l._panner.setPosition(e, i, n)),
                s._emit("pos", l._id)
            }
        }
        return s
    ...
    Howl.prototype.orientation = function(e, i, n, a) {
        ...
        for (var r = s._getSoundIds(a), o = 0; o < r.length; o++) {
            ...
            if (l) {
                ...
                l._panner.orientationZ.setValueAtTime(n, Howler.ctx.currentTime)) : l._panner.setOrientation(e, i, n)),
    ...
    Howl.prototype.pannerAttr = function() {
        ...
        if (1 === s.length) {
            if ("object" != typeof s[0])
                return (n = a._soundById(parseInt(s[0], 10))) ? n._pannerAttr : a._pannerAttr;
            e = s[0],
        ...
        for (var r = a._getSoundIds(i), o = 0; o < r.length; o++)
            if (n = a._soundById(r[o])) {
                ...
                d.panningModel = l.panningModel) : (n._pos || (n._pos = a._pos || [0, 0, -.5]),
                t(n, "spatial"))
            }
        return a
    }
    ...
    Sound.prototype.reset = function(e) {
        return function() {
            ...
            t._pos = i._pos,
            t._pannerAttr = i._pannerAttr,
            t._stereo ? i.stereo(t._stereo) : t._pos ? i.pos(t._pos[0], t._pos[1], t._pos[2], t._id) : t._panner && (t._panner.disconnect(0),
            t._panner = void 0,
            i._refreshBuffer(t)),
            e.call(this)
        }
    ...
    ***************************************************************************** */
    var e = function() {
      ...
      , t = function() {
        function e(e, t) {
            this.ATT_FACTOR = 4,
            this.GRAPH_X = 2,
            this.AMPLITUDE_FACTOR = .6,
            this.ctrl = e,
            this.definition = t
        }
        return e.prototype.globalAttFn = function(e) {
        ...
        e.prototype.draw = function() {
            ...
            e.strokeStyle = "rgba(" + t + "," + this.definition.opacity + ")",
            e.lineWidth = this.definition.lineWidth;
            for (var i = -this.GRAPH_X; i <= this.GRAPH_X; i += this.ctrl.opt.pixelDepth)
                e.lineTo(this.xPos(i), this.ctrl.heightMax + this.yPos(i));
            e.stroke()
        }
        ,
      ...
      , i = function() {
        function e(e, t) {
            this.GRAPH_X = 25,
            this.AMPLITUDE_FACTOR = .8,
            this.SPEED_FACTOR = 1,
            this.DEAD_PX = 2,
            this.ATT_FACTOR = 4,
            this.DESPAWN_FACTOR = .02,
            this.NOOFCURVES_RANGES = [2, 5],
            this.AMPLITUDE_RANGES = [.3, 1],
            this.OFFSET_RANGES = [-3, 3],
            this.WIDTH_RANGES = [1, 3],
            this.SPEED_RANGES = [.5, 1],
        ...
        return e.prototype.getRandomRange = function(e) {
        ...
        e.prototype.spawn = function() {
            ...
            for (var e = 0; e < this.noOfCurves; e++)
                this.spawnSingle(e)
        }
        ,
        ...
        e.prototype.drawSupportLine = function() {
            ...
            i.addColorStop(.8, "rgba(255,255,255,.5)"),
            i.addColorStop(1, "transparent"),
            e.fillStyle = i,
            e.fillRect.apply(e, t)
        }
        ,
        e.prototype.draw = function() {
            var e = this.ctrl.ctx;
            ...
            for (var i = -1 / 0, n = 0, a = [1, -1]; n < a.length; n++) {
                ...
                for (var r = -this.GRAPH_X; r <= this.GRAPH_X; r += this.ctrl.opt.pixelDepth) {
                    var o = this.xPos(r)
                      , l = this.yPos(r);
                    e.lineTo(o, this.ctrl.heightMax - s * l),
                    i = Math.max(i, l)
                }
                e.closePath(),
                e.fillStyle = "rgba(" + this.definition.color + ", 1)",
                e.strokeStyle = "rgba(" + this.definition.color + ", 1)",
                e.fill()
            }
            return i < this.DEAD_PX && this.prevMaxY > i && (this.spawnAt = 0),
            this.prevMaxY = i,
            null
        }
        ,
    ...
    return function() {
        function n(n) {
            ...
            !0 === this.opt.cover ? this.canvas.style.width = this.canvas.style.height = "100%" : (this.canvas.style.width = this.width / this.opt.ratio + "px",
        ...
        return n.prototype.hex2rgb = function(e) {
        ...
        n.prototype.lerp = function(e) {
            ...
            return null !== t && (this[e] = this.intLerp(this[e], t, this.opt.lerpSpeed),
            this[e] - t == 0 && (this.interpolation[e] = null)),
            this[e]
        }
        ,
