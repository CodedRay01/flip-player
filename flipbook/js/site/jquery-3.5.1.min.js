...
!function(t) {
    ...
    (u.fn = a.extend(u.prototype, {
        parse: function(o, t, e, n) {
            ...
            r = "array"),
            "string" === r ? this.parse(c(o) || M._default) : "array" === r ? (h(l.rgba.props, function(t, e) {
                s[e.idx] = m(o[e.idx], e)
            }),
    ...
    function T(t, e, n, r) {
        ...
        n = null,
        e = {}),
        "number" != typeof e && !d.fx.speeds[e] || (r = n,
        n = e,
        e = {}),
        ...
        return this.queue(function() {
            ...
            e = e.map(function() {
                ...
                this.diff = function(t, e) {
                    ...
                    for (n in e)
                        r = e[n],
                        t[n] !== r && (x[n] || !d.fx.step[n] && isNaN(parseFloat(r)) || (o[n] = r));
                    return o
                }(this.start, this.end),
                this
            }),
    ...
    d.fn.extend({
        ...
        removeClass: (b = d.fn.removeClass,
        function(t, e, n, r) {
        ...
        toggleClass: (i = d.fn.toggleClass,
        function(t, e, n, r, o) {
    ...
    d.expr && d.expr.pseudos && d.expr.pseudos.animated && (d.expr.pseudos.animated = (C = d.expr.pseudos.animated,
    function(t) {
    ...
    !1 !== d.uiBackCompat && d.extend(d.effects, {
        ...
        createWrapper: function(n) {
            ...
            return n.wrap(t),
            n[0] !== o && !d.contains(n[0], o) || d(o).trigger("focus"),
            t = n.parent(),
    ...
    d.extend(d.effects, {
        ...
        createPlaceholder: function(t) {
            ...
            e = d("<" + t[0].nodeName + ">").insertAfter(t).css({
        ...
        cleanUp: function(t) {
            d.effects.restoreStyle(t),
            d.effects.removePlaceholder(t)
        },
    ...
    d.fn.extend({
        effect: function() {
            function t(t) {
                ...
                i && "none" === n || d.effects.saveStyle(e),
                "function" == typeof t && t()
            }
            ...
            function f(t) {
                ...
                r.mode = c.shift(),
                !1 === d.uiBackCompat || i ? "none" === r.mode ? (e[a](),
    ...
    d.fx.step.clip = function(t) {
        t.clipInit || (t.start = d(t.elem).cssClip(),
    ...
    d.effects,
    d.effects.define("slide", "show", function(t, e) {
        var n, r, o = d(this), i = {
            up: ["bottom", "top"],
            down: ["top", "bottom"],
            left: ["right", "left"],
            right: ["left", "right"]
        }, s = t.mode, a = t.direction || "left", c = "up" === a || "down" === a ? "top" : "left", f = "up" === a || "left" === a, u = t.distance || o["top" == c ? "outerHeight" : "outerWidth"](!0), l = {};
        d.effects.createPlaceholder(o),
        n = o.cssClip(),
        r = o.position()[c],
        l[c] = (f ? -1 : 1) * u + r,
        l.clip = o.cssClip(),
        l.clip[i[a][1]] = l.clip[i[a][0]],
        "show" === s && (o.cssClip(l.clip),
        o.css(c, l[c]),
        l.clip = n,
        l[c] = r),
        o.animate(l, {
